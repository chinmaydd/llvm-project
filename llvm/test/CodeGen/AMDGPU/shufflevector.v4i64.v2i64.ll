...
; GFX900-NEXT:    v_mov_b32_e32 v9, v0
; GFX900-NEXT:    v_mov_b32_e32 v10, v1
; GFX900-NEXT:    global_store_dwordx4 v11, v[3:6], s[16:17] offset:16
...
; GFX900-NEXT:    global_store_dwordx4 v7, v[3:6], s[16:17] offset:16
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    global_store_dwordx4 v12, v[8:11], s[16:17] offset:16
; GFX900-NEXT:    global_store_dwordx4 v12, v[1:4], s[16:17]
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    v_mov_b32_e32 v5, v2
; GFX900-NEXT:    v_mov_b32_e32 v11, v0
; GFX900-NEXT:    v_mov_b32_e32 v12, v1
; GFX900-NEXT:    v_mov_b32_e32 v9, v4
; GFX900-NEXT:    global_store_dwordx4 v13, v[5:8], s[16:17] offset:16
; GFX900-NEXT:    global_store_dwordx4 v13, v[9:12], s[16:17]
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    v_mov_b32_e32 v0, v6
; GFX900-NEXT:    global_store_dwordx4 v11, v[7:10], s[16:17] offset:16
; GFX900-NEXT:    global_store_dwordx4 v11, v[0:3], s[16:17]
; GFX900-NEXT:    s_waitcnt vmcnt(0)
; GFX900-NEXT:    s_setpc_b64 s[30:31]
;
...
; GFX900-NEXT:    ;;#ASMEND
; GFX900-NEXT:    v_mov_b32_e32 v8, v3
; GFX900-NEXT:    global_store_dwordx4 v11, v[4:7], s[16:17]
; GFX900-NEXT:    s_nop 0
; GFX900-NEXT:    v_mov_b32_e32 v7, v2
; GFX900-NEXT:    global_store_dwordx4 v11, v[7:10], s[16:17] offset:16
; GFX900-NEXT:    s_waitcnt vmcnt(0)
