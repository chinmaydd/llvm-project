...
; CHECK-NEXT:    s_load_dwordx4 s[4:7], s[14:15], 0x0
; CHECK-NEXT:    s_load_dwordx16 s[16:31], s[10:11], 0x0
...
; CHECK-NEXT:    s_load_dwordx16 s[52:67], s[12:13], 0x0
...
; CHECK-NEXT:    image_sample_lz v3, v[2:3], s[24:31], s[68:71] dmask:0x1
; CHECK-NEXT:    v_mov_b32_e32 v2, v1
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    v_writelane_b32 v6, s52, 16
; CHECK-NEXT:    v_writelane_b32 v6, s53, 17
; CHECK-NEXT:    v_writelane_b32 v6, s54, 18
; CHECK-NEXT:    v_writelane_b32 v6, s55, 19
; CHECK-NEXT:    v_writelane_b32 v6, s56, 20
; CHECK-NEXT:    v_writelane_b32 v6, s57, 21
; CHECK-NEXT:    image_sample_lz v4, v[1:2], s[52:59], s[68:71] dmask:0x1
; CHECK-NEXT:    v_writelane_b32 v6, s58, 22
; CHECK-NEXT:    v_writelane_b32 v6, s59, 23
; CHECK-NEXT:    v_writelane_b32 v6, s60, 24
; CHECK-NEXT:    v_writelane_b32 v6, s61, 25
; CHECK-NEXT:    v_writelane_b32 v6, s62, 26
; CHECK-NEXT:    v_writelane_b32 v6, s63, 27
; CHECK-NEXT:    v_writelane_b32 v6, s64, 28
; CHECK-NEXT:    v_writelane_b32 v6, s65, 29
; CHECK-NEXT:    v_writelane_b32 v6, s66, 30
...
; CHECK-NEXT:    v_writelane_b32 v6, s67, 31
...
; CHECK-NEXT:    v_cmp_ne_u32_e64 s[20:21], 1, v0
; CHECK-NEXT:    s_waitcnt vmcnt(0)
; CHECK-NEXT:    v_mul_f32_e32 v0, v4, v3
; CHECK-NEXT:    s_and_saveexec_b64 s[6:7], s[20:21]
; CHECK-NEXT:    s_xor_b64 s[22:23], exec, s[6:7]
...
; CHECK-NEXT:    image_sample_lz v3, v[1:2], s[12:19], s[68:71] dmask:0x1
...
; CHECK-NEXT:    s_mov_b32 s71, s68
; CHECK-NEXT:    s_waitcnt lgkmcnt(0)
; CHECK-NEXT:    image_sample_lz v4, v[1:2], s[60:67], s[28:31] dmask:0x1
; CHECK-NEXT:    s_nop 0
...
; CHECK-NEXT:    s_andn2_saveexec_b64 s[6:7], s[22:23]
; CHECK-NEXT:    s_cbranch_execz .LBB0_10
; CHECK-NEXT:  ; %bb.4: ; %bb32
; CHECK-NEXT:    s_and_saveexec_b64 s[16:17], s[20:21]
...
; CHECK-NEXT:    image_sample_lz v2, v[0:1], s[36:43], s[16:19] dmask:0x1
...
; CHECK-NEXT:    image_sample_lz v0, v[0:1], s[44:51], s[24:27] dmask:0x1
