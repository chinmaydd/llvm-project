...
; GFX12-NEXT:    v_dual_mov_b32 v3, s5 :: v_dual_mov_b32 v2, s4
...
; GFX7-NEXT:    v_mov_b32_e32 v1, s1
; GFX7-NEXT:    s_lshl_b64 s[4:5], s[4:5], 3
; GFX7-NEXT:    s_add_u32 s1, s2, s4
; GFX7-NEXT:    s_addc_u32 s2, s3, s5
; GFX7-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-NEXT:    s_add_u32 s0, s1, 32
; GFX7-NEXT:    s_addc_u32 s1, s2, 0
; GFX7-NEXT:    v_mov_b32_e32 v3, s1
; GFX7-NEXT:    v_mov_b32_e32 v2, s0
; GFX7-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX7-NEXT:    s_endpgm
...
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    s_lshl_b64 s[4:5], s[4:5], 3
; GFX8-NEXT:    s_add_u32 s1, s2, s4
; GFX8-NEXT:    s_addc_u32 s2, s3, s5
; GFX8-NEXT:    v_mov_b32_e32 v0, s0
; GFX8-NEXT:    s_add_u32 s0, s1, 32
; GFX8-NEXT:    s_addc_u32 s1, s2, 0
; GFX8-NEXT:    v_mov_b32_e32 v3, s1
; GFX8-NEXT:    v_mov_b32_e32 v2, s0
; GFX8-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
; GFX8-NEXT:    s_endpgm
...
; GFX7-NEXT:    v_mov_b32_e32 v1, s1
; GFX7-NEXT:    s_lshl_b64 s[4:5], s[4:5], 3
; GFX7-NEXT:    s_add_u32 s2, s2, s4
; GFX7-NEXT:    s_addc_u32 s3, s3, s5
; GFX7-NEXT:    v_mov_b32_e32 v2, s2
; GFX7-NEXT:    v_mov_b32_e32 v0, s0
; GFX7-NEXT:    v_mov_b32_e32 v3, s3
; GFX7-NEXT:    flat_store_dwordx2 v[2:3], v[0:1]
...
; GFX12-NEXT:    s_load_b64 s[4:5], s[4:5], 0x34
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v2, s4
; GFX12-NEXT:    v_dual_mov_b32 v3, s5 :: v_dual_mov_b32 v0, s2
; GFX12-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v4, s0
...
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[8:9], s[2:3]
...
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    global_inv scope:SCOPE_DEV
; GFX12-NEXT:    v_dual_mov_b32 v3, s11 :: v_dual_mov_b32 v2, s10
; GFX12-NEXT:    flat_store_b64 v[2:3], v[0:1]
; GFX12-NEXT:    s_endpgm
entry:
  %ptr = getelementptr i64, ptr %out, i64 %index
