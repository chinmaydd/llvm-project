...
; SI-NOHSA-NEXT:    s_mov_b32 s5, s1
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v0, v2
; SI-NOHSA-NEXT:    v_mov_b32_e32 v2, v3
; SI-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; SI-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; SI-NOHSA-NEXT:    s_endpgm
;
...
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v4, s0
; GCNX3-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v2
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v0, v2
; GCNX3-HSA-NEXT:    v_mov_b32_e32 v2, v3
; GCNX3-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; GCNX3-HSA-NEXT:    flat_store_dwordx4 v[4:5], v[0:3]
; GCNX3-HSA-NEXT:    s_endpgm
;
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s1
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(0)
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v2
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v0, v2
; GCNX3-NOHSA-NEXT:    v_mov_b32_e32 v2, v3
; GCNX3-NOHSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    s_endpgm
;
...
; GCN-HSA-NEXT:    v_mov_b32_e32 v4, 0
; GCN-HSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-HSA-NEXT:    global_load_dwordx2 v[2:3], v4, s[2:3]
; GCN-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v1, 31, v2
; GCN-HSA-NEXT:    v_mov_b32_e32 v0, v2
; GCN-HSA-NEXT:    v_mov_b32_e32 v2, v3
; GCN-HSA-NEXT:    v_ashrrev_i32_e32 v3, 31, v3
; GCN-HSA-NEXT:    global_store_dwordx4 v4, v[0:3], s[0:1]
; GCN-HSA-NEXT:    s_endpgm
  %ld = load <2 x i32>, ptr addrspace(1) %in
...
; GCNX3-NOHSA-NEXT:    s_mov_b32 s7, 0xf000
; GCNX3-NOHSA-NEXT:    s_mov_b32 s6, -1
; GCNX3-NOHSA-NEXT:    s_add_u32 s88, s88, s11
; GCNX3-NOHSA-NEXT:    s_mov_b32 s11, s7
; GCNX3-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCNX3-NOHSA-NEXT:    s_mov_b32 s9, s3
; GCNX3-NOHSA-NEXT:    s_mov_b32 s8, s2
...
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[28:31], off, s[4:7], 0 offset:224
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[24:27], off, s[4:7], 0 offset:240
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[60:63], off, s[4:7], 0 offset:192
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[20:23], off, s[4:7], 0 offset:208
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[56:59], off, s[4:7], 0 offset:160
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[16:19], off, s[4:7], 0 offset:176
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[52:55], off, s[4:7], 0 offset:128
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[0:3], off, s[4:7], 0 offset:144
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[48:51], off, s[4:7], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[4:7], off, s[4:7], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[44:47], off, s[4:7], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[12:15], off, s[4:7], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[40:43], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[32:35], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[36:39], off, s[4:7], 0
...
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v12, off, s[20:23], 0 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    s_nop 0
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v13, off, s[20:23], 0 offset:4 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v14, off, s[20:23], 0 offset:8 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v15, off, s[20:23], 0 offset:12 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v16, off, s[20:23], 0 offset:16 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    s_nop 0
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v17, off, s[20:23], 0 offset:20 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v18, off, s[20:23], 0 offset:24 ; 4-byte Folded Spill
; GCN-GFX900-HSA-NEXT:    buffer_store_dword v19, off, s[20:23], 0 offset:28 ; 4-byte Folded Spill
...
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v0, off, s[20:23], 0 offset:16 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v1, off, s[20:23], 0 offset:20 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v2, off, s[20:23], 0 offset:24 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v3, off, s[20:23], 0 offset:28 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(0)
; GCN-GFX900-HSA-NEXT:    global_store_dwordx4 v24, v[0:3], s[0:1]
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v0, off, s[20:23], 0 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    s_nop 0
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v1, off, s[20:23], 0 offset:4 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v2, off, s[20:23], 0 offset:8 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    buffer_load_dword v3, off, s[20:23], 0 offset:12 ; 4-byte Folded Reload
; GCN-GFX900-HSA-NEXT:    s_waitcnt vmcnt(0)
...
; SI-NOHSA-NEXT:    s_mov_b32 s2, s6
; SI-NOHSA-NEXT:    s_mov_b32 s3, s7
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[0:3], 0
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[0:3], 0 offset:16
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[0:3], 0 offset:112
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[0:3], 0 offset:96
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[0:3], 0 offset:80
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[0:3], 0 offset:64
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[0:3], 0 offset:32
; SI-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[0:3], 0 offset:48
; SI-NOHSA-NEXT:    s_waitcnt vmcnt(4)
...
; GCNX3-NOHSA-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x24
; GCNX3-NOHSA-NEXT:    s_waitcnt lgkmcnt(0)
; GCNX3-NOHSA-NEXT:    s_mov_b32 s5, s3
; GCNX3-NOHSA-NEXT:    s_mov_b32 s4, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s3, 0xf000
; GCNX3-NOHSA-NEXT:    s_mov_b32 s2, -1
; GCNX3-NOHSA-NEXT:    s_mov_b32 s6, s2
; GCNX3-NOHSA-NEXT:    s_mov_b32 s7, s3
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[0:3], off, s[4:7], 0 offset:96
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[4:7], off, s[4:7], 0 offset:112
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[8:11], off, s[4:7], 0 offset:64
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[12:15], off, s[4:7], 0 offset:80
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[16:19], off, s[4:7], 0 offset:32
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[20:23], off, s[4:7], 0 offset:48
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[24:27], off, s[4:7], 0
; GCNX3-NOHSA-NEXT:    buffer_load_dwordx4 v[28:31], off, s[4:7], 0 offset:16
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
...
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
; GCNX3-NOHSA-NEXT:    buffer_store_dwordx4 v[8:11], off, s[0:3], 0 offset:64
; GCNX3-NOHSA-NEXT:    s_waitcnt vmcnt(7)
