...
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v1|, 0.5
; GFX9-NEXT:    v_trunc_f32_e32 v2, s10
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_sub_f32_e32 v4, s10, v2
; GFX9-NEXT:    v_mov_b32_e32 v3, s11
; GFX9-NEXT:    v_trunc_f32_e32 v6, s9
; GFX9-NEXT:    v_bfi_b32 v1, s6, v1, v3
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v4|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v5, s10
; GFX9-NEXT:    v_sub_f32_e32 v7, s9, v6
; GFX9-NEXT:    v_add_f32_e32 v3, v0, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_trunc_f32_e32 v9, s8
; GFX9-NEXT:    v_bfi_b32 v0, s6, v0, v5
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v7|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v8, s9
; GFX9-NEXT:    v_sub_f32_e32 v10, s8, v9
; GFX9-NEXT:    v_add_f32_e32 v2, v2, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_bfi_b32 v0, s6, v0, v8
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v10|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v11, s8
; GFX9-NEXT:    v_add_f32_e32 v1, v6, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_bfi_b32 v0, s6, v0, v11
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_trunc_f32_e32 v0, s11
; GFX6-NEXT:    v_trunc_f32_e32 v1, s10
; GFX6-NEXT:    v_sub_f32_e32 v2, s11, v0
; GFX6-NEXT:    v_sub_f32_e32 v3, s10, v1
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v2|, 0.5
; GFX6-NEXT:    v_trunc_f32_e32 v5, s9
; GFX6-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s[0:1]
; GFX6-NEXT:    v_sub_f32_e32 v6, s9, v5
; GFX6-NEXT:    v_mov_b32_e32 v19, s11
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v3|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v4, s10
; GFX6-NEXT:    v_trunc_f32_e32 v8, s8
; GFX6-NEXT:    v_bfi_b32 v2, s6, v2, v19
; GFX6-NEXT:    v_cndmask_b32_e64 v3, 0, 1.0, s[0:1]
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v6|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v7, s9
; GFX6-NEXT:    v_sub_f32_e32 v9, s8, v8
; GFX6-NEXT:    v_trunc_f32_e32 v11, s15
; GFX6-NEXT:    v_bfi_b32 v4, s6, v3, v4
; GFX6-NEXT:    v_add_f32_e32 v3, v0, v2
; GFX6-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[0:1]
; GFX6-NEXT:    v_sub_f32_e32 v12, s15, v11
; GFX6-NEXT:    v_bfi_b32 v0, s6, v0, v7
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v9|, 0.5
; GFX6-NEXT:    v_trunc_f32_e32 v14, s14
; GFX6-NEXT:    v_add_f32_e32 v2, v1, v4
; GFX6-NEXT:    v_add_f32_e32 v1, v5, v0
; GFX6-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v12|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v13, s15
; GFX6-NEXT:    v_sub_f32_e32 v15, s14, v14
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_trunc_f32_e32 v17, s13
; GFX6-NEXT:    v_bfi_b32 v5, s6, v5, v13
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v15|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v16, s14
; GFX6-NEXT:    v_sub_f32_e32 v18, s13, v17
; GFX6-NEXT:    v_add_f32_e32 v7, v11, v5
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_trunc_f32_e32 v19, s12
; GFX6-NEXT:    v_bfi_b32 v5, s6, v5, v16
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v18|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v4, s13
; GFX6-NEXT:    v_sub_f32_e32 v20, s12, v19
; GFX6-NEXT:    v_add_f32_e32 v6, v14, v5
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_bfi_b32 v4, s6, v5, v4
; GFX6-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v20|, 0.5
; GFX6-NEXT:    v_mov_b32_e32 v21, s12
; GFX6-NEXT:    v_add_f32_e32 v5, v17, v4
; GFX6-NEXT:    v_cndmask_b32_e64 v4, 0, 1.0, s[4:5]
; GFX6-NEXT:    v_mov_b32_e32 v10, s8
; GFX6-NEXT:    v_bfi_b32 v4, s6, v4, v21
; GFX6-NEXT:    v_bfi_b32 v0, s6, v0, v10
; GFX6-NEXT:    v_add_f32_e32 v4, v19, v4
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_trunc_f32_e32 v0, s11
; GFX8-NEXT:    v_trunc_f32_e32 v1, s10
; GFX8-NEXT:    v_sub_f32_e32 v2, s11, v0
; GFX8-NEXT:    v_sub_f32_e32 v3, s10, v1
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v2|, 0.5
; GFX8-NEXT:    v_trunc_f32_e32 v5, s9
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s[0:1]
; GFX8-NEXT:    v_sub_f32_e32 v6, s9, v5
; GFX8-NEXT:    v_mov_b32_e32 v19, s11
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v3|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v4, s10
; GFX8-NEXT:    v_trunc_f32_e32 v8, s8
; GFX8-NEXT:    v_bfi_b32 v2, s6, v2, v19
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1.0, s[0:1]
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v6|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v7, s9
; GFX8-NEXT:    v_sub_f32_e32 v9, s8, v8
; GFX8-NEXT:    v_trunc_f32_e32 v11, s15
; GFX8-NEXT:    v_bfi_b32 v4, s6, v3, v4
; GFX8-NEXT:    v_add_f32_e32 v3, v0, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[0:1]
; GFX8-NEXT:    v_sub_f32_e32 v12, s15, v11
; GFX8-NEXT:    v_bfi_b32 v0, s6, v0, v7
; GFX8-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v9|, 0.5
; GFX8-NEXT:    v_trunc_f32_e32 v14, s14
; GFX8-NEXT:    v_add_f32_e32 v2, v1, v4
; GFX8-NEXT:    v_add_f32_e32 v1, v5, v0
; GFX8-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v12|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v13, s15
; GFX8-NEXT:    v_sub_f32_e32 v15, s14, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_trunc_f32_e32 v17, s13
; GFX8-NEXT:    v_bfi_b32 v5, s6, v5, v13
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v15|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v16, s14
; GFX8-NEXT:    v_sub_f32_e32 v18, s13, v17
; GFX8-NEXT:    v_add_f32_e32 v7, v11, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_trunc_f32_e32 v19, s12
; GFX8-NEXT:    v_bfi_b32 v5, s6, v5, v16
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v18|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v4, s13
; GFX8-NEXT:    v_sub_f32_e32 v20, s12, v19
; GFX8-NEXT:    v_add_f32_e32 v6, v14, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_bfi_b32 v4, s6, v5, v4
; GFX8-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v20|, 0.5
; GFX8-NEXT:    v_mov_b32_e32 v21, s12
; GFX8-NEXT:    v_add_f32_e32 v5, v17, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1.0, s[4:5]
; GFX8-NEXT:    v_mov_b32_e32 v10, s8
; GFX8-NEXT:    v_bfi_b32 v4, s6, v4, v21
; GFX8-NEXT:    v_bfi_b32 v0, s6, v0, v10
; GFX8-NEXT:    v_add_f32_e32 v4, v19, v4
; GFX8-NEXT:    v_add_f32_e32 v0, v8, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_trunc_f32_e32 v0, s11
; GFX9-NEXT:    v_trunc_f32_e32 v1, s10
; GFX9-NEXT:    v_sub_f32_e32 v2, s11, v0
; GFX9-NEXT:    v_sub_f32_e32 v3, s10, v1
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v2|, 0.5
; GFX9-NEXT:    v_trunc_f32_e32 v5, s9
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1.0, s[0:1]
; GFX9-NEXT:    v_sub_f32_e32 v6, s9, v5
; GFX9-NEXT:    v_mov_b32_e32 v19, s11
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v3|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v4, s10
; GFX9-NEXT:    v_trunc_f32_e32 v8, s8
; GFX9-NEXT:    v_bfi_b32 v2, s6, v2, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1.0, s[0:1]
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[0:1], |v6|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v7, s9
; GFX9-NEXT:    v_sub_f32_e32 v9, s8, v8
; GFX9-NEXT:    v_trunc_f32_e32 v11, s15
; GFX9-NEXT:    v_bfi_b32 v4, s6, v3, v4
; GFX9-NEXT:    v_add_f32_e32 v3, v0, v2
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[0:1]
; GFX9-NEXT:    v_sub_f32_e32 v12, s15, v11
; GFX9-NEXT:    v_bfi_b32 v0, s6, v0, v7
; GFX9-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v9|, 0.5
; GFX9-NEXT:    v_trunc_f32_e32 v14, s14
; GFX9-NEXT:    v_add_f32_e32 v2, v1, v4
; GFX9-NEXT:    v_add_f32_e32 v1, v5, v0
; GFX9-NEXT:    v_cndmask_b32_e64 v0, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v12|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v13, s15
; GFX9-NEXT:    v_sub_f32_e32 v15, s14, v14
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_trunc_f32_e32 v17, s13
; GFX9-NEXT:    v_bfi_b32 v5, s6, v5, v13
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v15|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v16, s14
; GFX9-NEXT:    v_sub_f32_e32 v18, s13, v17
; GFX9-NEXT:    v_add_f32_e32 v7, v11, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_trunc_f32_e32 v19, s12
; GFX9-NEXT:    v_bfi_b32 v5, s6, v5, v16
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v18|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v4, s13
; GFX9-NEXT:    v_sub_f32_e32 v20, s12, v19
; GFX9-NEXT:    v_add_f32_e32 v6, v14, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_bfi_b32 v4, s6, v5, v4
; GFX9-NEXT:    v_cmp_ge_f32_e64 s[4:5], |v20|, 0.5
; GFX9-NEXT:    v_mov_b32_e32 v21, s12
; GFX9-NEXT:    v_add_f32_e32 v5, v17, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v4, 0, 1.0, s[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v10, s8
; GFX9-NEXT:    v_bfi_b32 v4, s6, v4, v21
; GFX9-NEXT:    v_bfi_b32 v0, s6, v0, v10
; GFX9-NEXT:    v_add_f32_e32 v4, v19, v4
; GFX9-NEXT:    v_add_f32_e32 v0, v8, v0
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
