...
; GFX6-NEXT:    s_mul_i32 s6, s6, s10
; GFX6-NEXT:    s_sub_i32 s5, s5, s6
; GFX6-NEXT:    s_sub_i32 s6, s5, s10
; GFX6-NEXT:    s_cmp_ge_u32 s5, s10
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_and_b32 s6, s2, 0x7fff
...
; GFX6-NEXT:    v_cvt_f32_u32_e32 v5, s4
; GFX6-NEXT:    s_bfe_u32 s7, s2, 0xf000f
...
; GFX6-NEXT:    s_and_b32 s1, s4, 0x7fff
; GFX6-NEXT:    v_cvt_f32_u32_e32 v0, s1
; GFX6-NEXT:    v_cvt_f32_u32_e32 v1, s3
; GFX6-NEXT:    s_mov_b32 s0, s8
; GFX6-NEXT:    s_bfe_u32 s8, s4, 0xf000f
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v2, v0
...
; GFX6-NEXT:    v_mad_f32 v1, -v2, v0, v1
; GFX6-NEXT:    v_cmp_ge_f32_e64 vcc, |v1|, v0
; GFX6-NEXT:    v_alignbit_b32 v1, s11, v3, 30
; GFX6-NEXT:    v_addc_u32_e32 v0, vcc, 0, v4, vcc
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, s4
; GFX6-NEXT:    v_mov_b32_e32 v3, s4
; GFX6-NEXT:    v_alignbit_b32 v3, s5, v3, 30
...
; GFX6-NEXT:    v_sub_i32_e32 v4, vcc, s6, v0
; GFX6-NEXT:    v_and_b32_e32 v2, 0x7fff, v2
...
; GFX6-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_bfe_i32 s7, s2, 0xf0000
; GFX6-NEXT:    s_bfe_i32 s6, s4, 0xf0000
; GFX6-NEXT:    v_cvt_f32_i32_e32 v1, s6
; GFX6-NEXT:    v_cvt_f32_i32_e32 v2, s7
; GFX6-NEXT:    v_mov_b32_e32 v0, s2
; GFX6-NEXT:    v_alignbit_b32 v0, s3, v0, 30
; GFX6-NEXT:    v_rcp_iflag_f32_e32 v3, v1
; GFX6-NEXT:    s_xor_b32 s3, s7, s6
...
; GFX6-NEXT:    v_cvt_f32_i32_e32 v3, s4
; GFX6-NEXT:    s_bfe_i32 s7, s2, 0xf000f
...
; GFX6-NEXT:    s_and_b64 s[6:7], s[6:7], exec
; GFX6-NEXT:    s_cselect_b32 s6, s10, 0
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, s6, v2
; GFX6-NEXT:    v_mul_lo_u32 v0, v0, s4
; GFX6-NEXT:    v_mov_b32_e32 v3, s4
; GFX6-NEXT:    s_bfe_i32 s4, s4, 0xf000f
; GFX6-NEXT:    v_cvt_f32_i32_e32 v4, s4
; GFX6-NEXT:    s_bfe_i32 s6, s2, 0xf000f
...
; GFX6-NEXT:    v_alignbit_b32 v1, s3, v1, 30
; GFX6-NEXT:    s_and_b64 s[4:5], s[4:5], exec
; GFX6-NEXT:    v_sub_i32_e32 v2, vcc, s2, v0
...
; GFX6-NEXT:    v_mul_lo_u32 v4, v4, s9
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v1, v3
; GFX6-NEXT:    v_mul_lo_u32 v1, v1, v5
; GFX6-NEXT:    v_sub_i32_e32 v3, vcc, s8, v4
; GFX6-NEXT:    v_and_b32_e32 v3, 0x7fff, v3
...
; GFX6-NEXT:    s_lshr_b64 s[4:5], s[2:3], s4
; GFX6-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX6-NEXT:    s_mul_i32 s6, s11, 0x10010011
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s6, v3
; GFX6-NEXT:    s_mul_i32 s2, s10, 0x100100
; GFX6-NEXT:    v_addc_u32_e32 v2, vcc, 0, v2, vcc
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, s2, v3
; GFX6-NEXT:    v_mul_hi_u32 v0, s11, v0
; GFX6-NEXT:    v_addc_u32_e32 v1, vcc, 0, v1, vcc
; GFX6-NEXT:    v_add_i32_e32 v1, vcc, v2, v1
; GFX6-NEXT:    s_mul_i32 s2, s11, 0x100100
...
; GFX6-NEXT:    s_load_dword s4, s[4:5], 0xd
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_lshl_b64 s[4:5], 0x1000, s4
; GFX6-NEXT:    s_add_u32 s4, s4, -1
; GFX6-NEXT:    s_addc_u32 s5, s5, -1
; GFX6-NEXT:    s_and_b64 s[4:5], s[2:3], s[4:5]
; GFX6-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-NEXT:    s_mov_b32 s3, 0xf000
; GFX6-NEXT:    s_mov_b32 s2, -1
; GFX6-NEXT:    v_mov_b32_e32 v1, s5
...
; GFX6-NEXT:    v_subrev_i32_e64 v5, s[0:1], s8, v3
; GFX6-NEXT:    v_subbrev_u32_e64 v4, s[0:1], 0, v4, s[0:1]
; GFX6-NEXT:    v_cmp_le_u32_e64 s[0:1], s9, v4
; GFX6-NEXT:    v_cndmask_b32_e64 v6, 0, -1, s[0:1]
; GFX6-NEXT:    v_cmp_le_u32_e64 s[0:1], s8, v5
; GFX6-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[0:1]
; GFX6-NEXT:    v_cmp_eq_u32_e64 s[0:1], s9, v4
...
; GFX6-NEXT:    s_xor_b64 s[0:1], s[10:11], s[2:3]
