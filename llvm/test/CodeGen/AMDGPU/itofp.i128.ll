...
; GISEL-NEXT:    s_or_saveexec_b64 s[10:11], s[4:5]
...
; GISEL-NEXT:    v_add_u32_e32 v15, 26, v5
; GISEL-NEXT:    v_cndmask_b32_e32 v9, v9, v11, vcc
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v10, v12, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_sub_u32_e32 v4, 64, v15
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v9, v0, vcc
; GISEL-NEXT:    v_lshrrev_b64 v[9:10], v15, -1
; GISEL-NEXT:    v_lshlrev_b64 v[11:12], v4, -1
; GISEL-NEXT:    v_add_u32_e32 v4, 0xffffffda, v5
; GISEL-NEXT:    v_lshrrev_b64 v[4:5], v4, -1
; GISEL-NEXT:    v_or_b32_e32 v11, v9, v11
; GISEL-NEXT:    v_or_b32_e32 v12, v10, v12
; GISEL-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v4, v11, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v5, v12, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v9, 0, v9, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v10, 0, v10, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v4, -1, s[6:7]
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v5, -1, s[6:7]
; GISEL-NEXT:    v_and_b32_e32 v2, v9, v2
; GISEL-NEXT:    v_and_b32_e32 v3, v10, v3
; GISEL-NEXT:    v_and_or_b32 v2, v4, v0, v2
; GISEL-NEXT:    v_and_or_b32 v3, v5, v1, v3
; GISEL-NEXT:    v_cndmask_b32_e32 v1, v13, v1, vcc
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[2:3]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v0, v14, v0
...
; GISEL-NEXT:    v_cndmask_b32_e32 v12, v9, v11, vcc
; GISEL-NEXT:    v_cmp_eq_u32_e32 vcc, 0, v4
; GISEL-NEXT:    v_sub_u32_e32 v4, 64, v14
; GISEL-NEXT:    v_cndmask_b32_e32 v13, v8, v0, vcc
; GISEL-NEXT:    v_lshrrev_b64 v[8:9], v14, -1
; GISEL-NEXT:    v_lshlrev_b64 v[10:11], v4, -1
; GISEL-NEXT:    v_add_u32_e32 v4, 0xffffffda, v5
; GISEL-NEXT:    v_lshrrev_b64 v[4:5], v4, -1
; GISEL-NEXT:    v_or_b32_e32 v10, v8, v10
; GISEL-NEXT:    v_or_b32_e32 v11, v9, v11
; GISEL-NEXT:    v_cmp_gt_u32_e64 s[4:5], 64, v14
; GISEL-NEXT:    v_cndmask_b32_e64 v4, v4, v10, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v5, v5, v11, s[4:5]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[6:7], 0, v14
...
; SDAG-NEXT:    v_lshlrev_b64 v[0:1], v2, v[6:7]
; SDAG-NEXT:    v_cmp_gt_u32_e32 vcc, 64, v2
...
; SDAG-NEXT:  ; %bb.3: ; %Flow3
; SDAG-NEXT:    s_or_saveexec_b64 s[10:11], s[4:5]
; SDAG-NEXT:    v_sub_u32_e32 v8, 0x7f, v9
; SDAG-NEXT:    s_xor_b64 exec, exec, s[10:11]
...
; SDAG-NEXT:    v_lshlrev_b32_e32 v4, 29, v4
...
; GISEL-NEXT:    ; implicit-def: $vgpr2
; GISEL-NEXT:  ; %bb.3: ; %Flow3
; GISEL-NEXT:    s_or_saveexec_b64 s[12:13], s[4:5]
...
; GISEL-NEXT:    v_sub_u32_e32 v10, 64, v15
...
; GISEL-NEXT:    v_or_b32_e32 v16, v0, v10
; GISEL-NEXT:    v_lshrrev_b64 v[9:10], v9, -1
; GISEL-NEXT:    v_or_b32_e32 v11, v1, v11
; GISEL-NEXT:    v_cmp_gt_u32_e64 s[6:7], 64, v15
...
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, v0, s[6:7]
; GISEL-NEXT:    v_cndmask_b32_e64 v1, 0, v1, s[6:7]
...
; GISEL-NEXT:    v_cndmask_b32_e32 v4, 0, v12, vcc
; GISEL-NEXT:    v_cmp_ne_u64_e32 vcc, 0, v[0:1]
; GISEL-NEXT:    v_cndmask_b32_e64 v3, v13, v3, s[4:5]
; GISEL-NEXT:    v_cndmask_b32_e64 v0, 0, 1, vcc
; GISEL-NEXT:    v_or_b32_e32 v2, v14, v0
...
; GISEL-NEXT:    v_sub_u32_e32 v9, 64, v15
; GISEL-NEXT:    v_lshrrev_b64 v[11:12], v13, v[2:3]
; GISEL-NEXT:    v_cndmask_b32_e32 v14, v5, v10, vcc
...
; GISEL-NEXT:    v_lshrrev_b64 v[8:9], v8, -1
; GISEL-NEXT:    v_or_b32_e32 v10, v5, v10
; GISEL-NEXT:    v_cmp_gt_u32_e64 s[6:7], 64, v15
; GISEL-NEXT:    v_cndmask_b32_e64 v8, v8, v16, s[6:7]
; GISEL-NEXT:    v_cndmask_b32_e64 v9, v9, v10, s[6:7]
; GISEL-NEXT:    v_cmp_eq_u32_e64 s[8:9], 0, v15
