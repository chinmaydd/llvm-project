...
; GCN-IR-NEXT:    s_xor_b32 s5, s6, s4
...
; GCN-IR-NEXT:    s_sub_i32 s4, s6, s5
...
; GCN-NEXT:    v_readfirstlane_b32 s7, v0
; GCN-NEXT:    s_mul_i32 s7, s7, s6
; GCN-NEXT:    s_sub_i32 s4, s4, s7
; GCN-NEXT:    s_sub_i32 s7, s4, s6
; GCN-NEXT:    s_cmp_ge_u32 s4, s6
; GCN-NEXT:    s_cselect_b32 s4, s7, s4
; GCN-NEXT:    s_sub_i32 s7, s4, s6
; GCN-NEXT:    s_cmp_ge_u32 s4, s6
; GCN-NEXT:    s_cselect_b32 s4, s7, s4
...
; GCN-IR-NEXT:    s_ashr_i32 s5, s3, 31
; GCN-IR-NEXT:    v_mul_f32_e32 v0, 0x4f7ffffe, v0
; GCN-IR-NEXT:    v_cvt_u32_f32_e32 v0, v0
; GCN-IR-NEXT:    s_mov_b32 s3, 0xf000
; GCN-IR-NEXT:    v_mul_lo_u32 v1, s2, v0
...
; GCN-IR-NEXT:    v_readfirstlane_b32 s7, v0
; GCN-IR-NEXT:    s_mul_i32 s7, s7, s6
; GCN-IR-NEXT:    s_sub_i32 s4, s4, s7
; GCN-IR-NEXT:    s_sub_i32 s7, s4, s6
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s6
; GCN-IR-NEXT:    s_cselect_b32 s4, s7, s4
; GCN-IR-NEXT:    s_sub_i32 s7, s4, s6
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s6
; GCN-IR-NEXT:    s_cselect_b32 s4, s7, s4
...
; GCN-NEXT:    s_ashr_i64 s[8:9], s[4:5], 31
; GCN-NEXT:    s_ashr_i32 s4, s5, 31
; GCN-NEXT:    s_add_u32 s8, s8, s4
; GCN-NEXT:    s_mov_b32 s5, s4
; GCN-NEXT:    s_addc_u32 s9, s9, s4
