...
; GFX9-SDAG-NEXT:    s_mov_b32 s0, s1
; GFX9-SDAG-NEXT:    s_mov_b32 s1, s10
; GFX9-SDAG-NEXT:    s_or_b64 s[4:5], s[0:1], s[10:11]
...
; GFX942-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX942-SDAG-NEXT:    s_or_b64 s[8:9], s[0:1], s[12:13]
...
; GFX942-SDAG-NEXT:    s_mov_b32 s0, s1
; GFX942-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX942-SDAG-NEXT:    s_or_b64 s[4:5], s[0:1], s[12:13]
...
; GFX10-SDAG-NEXT:    s_mov_b32 s0, s1
; GFX10-SDAG-NEXT:    s_mov_b32 s1, s10
; GFX10-SDAG-NEXT:    s_or_b64 s[4:5], s[0:1], s[10:11]
...
; GFX10-GISEL-NEXT:    s_mov_b32 s11, 0
; GFX10-GISEL-NEXT:    s_mov_b32 s4, s11
; GFX10-GISEL-NEXT:    s_mov_b32 s6, s11
; GFX10-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-GISEL-NEXT:    s_mov_b32 s10, s1
; GFX10-GISEL-NEXT:    s_mov_b32 s5, s2
; GFX10-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX10-GISEL-NEXT:    s_or_b64 s[4:5], s[10:11], s[4:5]
; GFX10-GISEL-NEXT:    s_mov_b32 s10, s3
; GFX10-GISEL-NEXT:    s_or_b64 s[6:7], s[10:11], s[6:7]
...
; GFX11-SDAG-NEXT:    s_mov_b32 s0, s1
; GFX11-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b64 s[8:9], s[0:1], s[12:13]
...
; GFX11-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX11-SDAG-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-SDAG-NEXT:    s_or_b64 s[4:5], s[0:1], s[12:13]
...
; GFX11-GISEL-NEXT:    s_mov_b32 s13, 0
; GFX11-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-NEXT:    s_mov_b32 s8, s13
; GFX11-GISEL-NEXT:    s_mov_b32 s6, s13
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-GISEL-NEXT:    s_mov_b32 s12, s1
; GFX11-GISEL-NEXT:    s_mov_b32 s9, s2
; GFX11-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-GISEL-NEXT:    s_or_b64 s[8:9], s[12:13], s[8:9]
; GFX11-GISEL-NEXT:    s_mov_b32 s12, s3
; GFX11-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-GISEL-NEXT:    s_or_b64 s[10:11], s[12:13], s[6:7]
...
; GFX11-GISEL-NEXT:    s_mov_b32 s4, s13
; GFX11-GISEL-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-GISEL-NEXT:    s_or_b64 s[4:5], s[12:13], s[4:5]
; GFX11-GISEL-NEXT:    s_mov_b32 s12, s3
; GFX11-GISEL-NEXT:    s_or_b64 s[6:7], s[12:13], s[6:7]
...
; GFX12-SDAG-NEXT:    s_mov_b32 s0, s1
; GFX12-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX12-SDAG-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-NEXT:    s_or_b64 s[8:9], s[0:1], s[12:13]
...
; GFX12-SDAG-NEXT:    s_mov_b32 s1, s12
; GFX12-SDAG-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-NEXT:    s_or_b64 s[4:5], s[0:1], s[12:13]
...
; GFX12-GISEL-NEXT:    s_mov_b32 s13, 0
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_mov_b32 s8, s13
; GFX12-GISEL-NEXT:    s_mov_b32 s6, s13
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
; GFX12-GISEL-NEXT:    s_mov_b32 s12, s1
; GFX12-GISEL-NEXT:    s_mov_b32 s9, s2
; GFX12-GISEL-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-GISEL-NEXT:    s_or_b64 s[8:9], s[12:13], s[8:9]
; GFX12-GISEL-NEXT:    s_mov_b32 s12, s3
; GFX12-GISEL-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-GISEL-NEXT:    s_or_b64 s[10:11], s[12:13], s[6:7]
...
; GFX12-GISEL-NEXT:    s_mov_b32 s4, s13
; GFX12-GISEL-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-GISEL-NEXT:    s_or_b64 s[4:5], s[12:13], s[4:5]
; GFX12-GISEL-NEXT:    s_mov_b32 s12, s3
; GFX12-GISEL-NEXT:    s_or_b64 s[6:7], s[12:13], s[6:7]
