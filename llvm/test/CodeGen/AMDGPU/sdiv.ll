...
; GFX9-NEXT:    s_ashr_i32 s4, s4, 31
; GFX9-NEXT:    v_readfirstlane_b32 s5, v0
; GFX9-NEXT:    s_mul_i32 s10, s10, s5
; GFX9-NEXT:    s_mul_hi_u32 s7, s5, s10
; GFX9-NEXT:    s_add_i32 s5, s5, s7
; GFX9-NEXT:    s_mul_hi_u32 s5, s9, s5
; GFX9-NEXT:    s_mul_i32 s7, s5, s8
; GFX9-NEXT:    s_sub_i32 s7, s9, s7
; GFX9-NEXT:    s_add_i32 s10, s5, 1
; GFX9-NEXT:    s_sub_i32 s9, s7, s8
; GFX9-NEXT:    s_cmp_ge_u32 s7, s8
