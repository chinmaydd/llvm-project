...
; GCN-NEXT:    s_xor_b64 s[0:1], s[10:11], s[2:3]
...
; GCN-NEXT:    s_ashr_i64 s[6:7], s[2:3], 40
...
; GCN-NEXT:    s_sub_i32 s2, 0, s7
; GCN-NEXT:    s_abs_i32 s4, s3
; GCN-NEXT:    s_xor_b32 s5, s3, s6
...
; GCN-NEXT:    s_mul_i32 s8, s6, s7
; GCN-NEXT:    s_sub_i32 s4, s4, s8
; GCN-NEXT:    s_add_i32 s9, s6, 1
; GCN-NEXT:    s_sub_i32 s8, s4, s7
...
; GCN-IR-NEXT:    s_sub_i32 s2, 0, s7
; GCN-IR-NEXT:    s_abs_i32 s4, s3
; GCN-IR-NEXT:    s_xor_b32 s5, s3, s6
; GCN-IR-NEXT:    v_rcp_iflag_f32_e32 v0, v0
; GCN-IR-NEXT:    s_ashr_i32 s5, s5, 31
; GCN-IR-NEXT:    s_mov_b32 s3, 0xf000
...
; GCN-IR-NEXT:    s_mul_i32 s8, s6, s7
; GCN-IR-NEXT:    s_sub_i32 s4, s4, s8
; GCN-IR-NEXT:    s_add_i32 s9, s6, 1
; GCN-IR-NEXT:    s_sub_i32 s8, s4, s7
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s7
; GCN-IR-NEXT:    s_cselect_b32 s6, s9, s6
; GCN-IR-NEXT:    s_cselect_b32 s4, s8, s4
; GCN-IR-NEXT:    s_add_i32 s8, s6, 1
; GCN-IR-NEXT:    s_cmp_ge_u32 s4, s7
; GCN-IR-NEXT:    s_cselect_b32 s4, s8, s6
; GCN-IR-NEXT:    s_xor_b32 s4, s4, s5
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i64 s[6:7], s[0:1], 33
; GCN-NEXT:    s_abs_i32 s7, s6
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s7
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-NEXT:    s_mul_i32 s8, s6, s7
; GCN-NEXT:    s_sub_i32 s5, s5, s8
; GCN-NEXT:    s_add_i32 s9, s6, 1
; GCN-NEXT:    s_sub_i32 s8, s5, s7
; GCN-NEXT:    s_cmp_ge_u32 s5, s7
; GCN-NEXT:    s_cselect_b32 s6, s9, s6
; GCN-NEXT:    s_cselect_b32 s5, s8, s5
; GCN-NEXT:    s_add_i32 s8, s6, 1
; GCN-NEXT:    s_cmp_ge_u32 s5, s7
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i64 s[6:7], s[0:1], 33
; GCN-IR-NEXT:    s_abs_i32 s7, s6
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s7
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    v_readfirstlane_b32 s6, v0
; GCN-IR-NEXT:    s_mul_i32 s8, s6, s7
; GCN-IR-NEXT:    s_sub_i32 s5, s5, s8
; GCN-IR-NEXT:    s_add_i32 s9, s6, 1
; GCN-IR-NEXT:    s_sub_i32 s8, s5, s7
; GCN-IR-NEXT:    s_cmp_ge_u32 s5, s7
; GCN-IR-NEXT:    s_cselect_b32 s6, s9, s6
; GCN-IR-NEXT:    s_cselect_b32 s5, s8, s5
; GCN-IR-NEXT:    s_add_i32 s8, s6, 1
; GCN-IR-NEXT:    s_cmp_ge_u32 s5, s7
...
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_mov_b32 s2, -1
; GCN-NEXT:    s_ashr_i64 s[6:7], s[2:3], 41
...
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_mov_b32 s2, -1
; GCN-IR-NEXT:    s_ashr_i64 s[6:7], s[2:3], 41
...
; GCN-NEXT:    s_load_dword s1, s[4:5], 0xe
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-NEXT:    s_ashr_i64 s[6:7], s[0:1], 39
; GCN-NEXT:    s_abs_i32 s7, s6
; GCN-NEXT:    v_cvt_f32_u32_e32 v0, s7
; GCN-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    s_load_dword s1, s[4:5], 0xe
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
; GCN-IR-NEXT:    s_ashr_i64 s[6:7], s[0:1], 39
; GCN-IR-NEXT:    s_abs_i32 s7, s6
; GCN-IR-NEXT:    v_cvt_f32_u32_e32 v0, s7
; GCN-IR-NEXT:    s_load_dwordx4 s[0:3], s[4:5], 0x9
; GCN-IR-NEXT:    s_waitcnt lgkmcnt(0)
...
; GCN-IR-NEXT:    s_sext_i32_i16 s2, s5
; GCN-IR-NEXT:    v_mov_b32_e32 v1, s4
; GCN-IR-NEXT:    v_alignbit_b32 v1, s2, v1, 24
; GCN-IR-NEXT:    v_cvt_f32_i32_e32 v2, v1
; GCN-IR-NEXT:    s_sext_i32_i16 s6, s3
; GCN-IR-NEXT:    v_alignbit_b32 v0, s6, v0, 24
...
; GCN-IR-NEXT:    v_mul_f32_e32 v1, v3, v4
; GCN-IR-NEXT:    v_trunc_f32_e32 v1, v1
; GCN-IR-NEXT:    v_mad_f32 v3, -v1, v2, v3
