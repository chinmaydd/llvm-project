...
; GFX9-NEXT:    buffer_load_ushort v0, off, s[0:3], 0
; GFX9-NEXT:    buffer_load_ushort v1, off, s[4:7], 0
...
; GFX9-NEXT:    buffer_load_dword v1, off, s[4:7], 0
...
; VI-NEXT:    v_fma_f16 v2, v3, s0, v2
; VI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_fma_f16 v0, v1, s0, v0
...
; VI-NEXT:    s_waitcnt vmcnt(0)
; VI-NEXT:    v_lshrrev_b32_e32 v3, 16, v1
; VI-NEXT:    v_fma_f16 v2, v3, v2, s0
; VI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; VI-NEXT:    v_fma_f16 v0, v1, v0, s0
; VI-NEXT:    v_or_b32_e32 v0, v0, v2
; VI-NEXT:    buffer_store_dword v0, off, s[4:7], 0
; VI-NEXT:    s_endpgm
;
...
; VI-NEXT:    buffer_load_dwordx2 v[4:5], off, s[8:11], 0
; VI-NEXT:    s_waitcnt vmcnt(2)
