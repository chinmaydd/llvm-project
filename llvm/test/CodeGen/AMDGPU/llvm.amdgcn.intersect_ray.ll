...
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s4
; GFX11-TRUE16-NEXT:    s_lshr_b32 s3, s7, 16
...
; GFX11-TRUE16-NEXT:    s_mov_b32 s6, s7
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s3, s3, s4
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s4, s5, s6
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v4, s2
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v3, s4 :: v_dual_mov_b32 v6, s0
...
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s4
; GFX11-FAKE16-NEXT:    s_lshr_b32 s3, s7, 16
; GFX11-FAKE16-NEXT:    s_lshr_b32 s4, s5, 16
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s2, s4, s3
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s3, s6, s8
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s4, s5, s7
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v4, s2
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v3, s4 :: v_dual_mov_b32 v6, s0
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v7, s1
...
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s4
; GFX12-SDAG-TRUE16-NEXT:    s_lshr_b32 s3, s7, 16
; GFX12-SDAG-TRUE16-NEXT:    s_lshr_b32 s4, s5, 16
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s2, s4, s3
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s3, s6
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s4, s8
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s6, s7
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s3, s3, s4
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s4, s5, s6
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v4, s2
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v3, s4 :: v_dual_mov_b32 v6, s0
...
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v2, s4
; GFX12-SDAG-FAKE16-NEXT:    s_lshr_b32 s3, s7, 16
; GFX12-SDAG-FAKE16-NEXT:    s_lshr_b32 s4, s5, 16
; GFX12-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v0, s2
; GFX12-SDAG-FAKE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s2, s4, s3
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s3, s6, s8
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s4, s5, s7
; GFX12-SDAG-FAKE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v5, s3 :: v_dual_mov_b32 v4, s2
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v3, s4 :: v_dual_mov_b32 v6, s0
; GFX12-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v7, s1
...
; GFX11-TRUE16:       ; %bb.0: ; %main_body
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v7, s1
; GFX11-TRUE16-NEXT:    s_lshr_b32 s1, s8, 16
...
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s0, s3, s1
; GFX11-TRUE16-NEXT:    s_mov_b32 s1, s7
; GFX11-TRUE16-NEXT:    s_mov_b32 s3, s9
; GFX11-TRUE16-NEXT:    s_mov_b32 s4, s6
; GFX11-TRUE16-NEXT:    s_mov_b32 s5, s8
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s1, s1, s3
; GFX11-TRUE16-NEXT:    s_pack_ll_b32_b16 s3, s4, s5
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v4, s0
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v3, s3 :: v_dual_mov_b32 v8, s2
...
; GFX11-FAKE16:       ; %bb.0: ; %main_body
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v7, s1
; GFX11-FAKE16-NEXT:    s_lshr_b32 s1, s8, 16
; GFX11-FAKE16-NEXT:    s_lshr_b32 s3, s6, 16
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v6, s0
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s0, s3, s1
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s1, s7, s9
; GFX11-FAKE16-NEXT:    s_pack_ll_b32_b16 s3, s6, s8
; GFX11-FAKE16-NEXT:    v_mov_b32_e32 v5, s1
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v2, s5
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v4, s0 :: v_dual_mov_b32 v3, s3
...
; GFX12-SDAG-TRUE16:       ; %bb.0: ; %main_body
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v7, s1
; GFX12-SDAG-TRUE16-NEXT:    s_lshr_b32 s1, s8, 16
; GFX12-SDAG-TRUE16-NEXT:    s_lshr_b32 s3, s6, 16
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v2, s5
; GFX12-SDAG-TRUE16-NEXT:    v_mov_b32_e32 v6, s0
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s0, s3, s1
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s1, s7
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s3, s9
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s4, s6
; GFX12-SDAG-TRUE16-NEXT:    s_mov_b32 s5, s8
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s1, s1, s3
; GFX12-SDAG-TRUE16-NEXT:    s_pack_ll_b32_b16 s3, s4, s5
; GFX12-SDAG-TRUE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v4, s0
; GFX12-SDAG-TRUE16-NEXT:    v_dual_mov_b32 v3, s3 :: v_dual_mov_b32 v8, s2
...
; GFX12-SDAG-FAKE16:       ; %bb.0: ; %main_body
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v0, s3 :: v_dual_mov_b32 v7, s1
; GFX12-SDAG-FAKE16-NEXT:    s_lshr_b32 s1, s8, 16
; GFX12-SDAG-FAKE16-NEXT:    s_lshr_b32 s3, s6, 16
; GFX12-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v6, s0
; GFX12-SDAG-FAKE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s0, s3, s1
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s1, s7, s9
; GFX12-SDAG-FAKE16-NEXT:    s_pack_ll_b32_b16 s3, s6, s8
; GFX12-SDAG-FAKE16-NEXT:    s_wait_alu 0xfffe
; GFX12-SDAG-FAKE16-NEXT:    v_mov_b32_e32 v5, s1
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v1, s4 :: v_dual_mov_b32 v2, s5
; GFX12-SDAG-FAKE16-NEXT:    v_dual_mov_b32 v4, s0 :: v_dual_mov_b32 v3, s3
