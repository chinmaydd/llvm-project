...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_hi_i32 s3, s2, 0x50
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_i32 s3, s2, 0x50
...
; GFX10-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_mul_hi_u32 s3, s2, 0x50
; GFX10-NEXT:    s_mulk_i32 s2, 0x50
; GFX10-NEXT:    v_mov_b32_e32 v1, s3
; GFX10-NEXT:    v_mov_b32_e32 v0, s2
; GFX10-NEXT:    s_mov_b32 s3, 0x31016000
...
; GFX11-NEXT:    s_load_b64 s[0:1], s[4:5], 0x24
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    s_mul_hi_u32 s3, s2, 0x50
; GFX11-NEXT:    s_mulk_i32 s2, 0x50
; GFX11-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX11-NEXT:    v_dual_mov_b32 v1, s3 :: v_dual_mov_b32 v0, s2
; GFX11-NEXT:    s_mov_b32 s3, 0x31016000
...
; SI-NEXT:    s_mul_i32 s5, s2, s5
; SI-NEXT:    s_mul_i32 s6, s3, s4
; SI-NEXT:    s_mul_i32 s7, s2, s4
...
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v0, s4
; VI-NEXT:    s_mul_i32 s5, s2, s5
; VI-NEXT:    s_mul_i32 s6, s3, s4
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], s2, v0, 0
; VI-NEXT:    s_mov_b32 s3, 0xf000
; VI-NEXT:    s_mov_b32 s2, -1
...
; SI-LABEL: s_mul_i128:
; SI:       ; %bb.0: ; %entry
; SI-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x13
; SI-NEXT:    s_load_dwordx4 s[8:11], s[4:5], 0x1f
; SI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    s_waitcnt lgkmcnt(0)
...
; SI-NEXT:    v_mul_hi_u32 v2, s12, v1
; SI-NEXT:    v_mul_hi_u32 v5, s13, v1
; SI-NEXT:    v_mov_b32_e32 v1, s14
; SI-NEXT:    v_mul_hi_u32 v1, s8, v1
; SI-NEXT:    v_mul_hi_u32 v0, s10, v0
; SI-NEXT:    s_mul_i32 s4, s8, s15
; SI-NEXT:    s_mul_i32 s7, s10, s13
; SI-NEXT:    v_mov_b32_e32 v3, s8
; SI-NEXT:    s_mul_i32 s5, s9, s14
; SI-NEXT:    s_mul_i32 s11, s11, s12
; SI-NEXT:    s_mul_i32 s15, s10, s12
; SI-NEXT:    v_mul_hi_u32 v4, s13, v3
; SI-NEXT:    v_mul_hi_u32 v3, s12, v3
; SI-NEXT:    v_add_i32_e32 v1, vcc, s4, v1
; SI-NEXT:    v_add_i32_e32 v0, vcc, s7, v0
; SI-NEXT:    s_mul_i32 s6, s8, s14
...
; VI-NEXT:    s_load_dwordx4 s[12:15], s[4:5], 0x4c
; VI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x24
; VI-NEXT:    v_mov_b32_e32 v2, 0
; VI-NEXT:    s_waitcnt lgkmcnt(0)
; VI-NEXT:    v_mov_b32_e32 v3, s8
; VI-NEXT:    v_mad_u64_u32 v[0:1], s[2:3], s12, v3, 0
; VI-NEXT:    v_mov_b32_e32 v8, s9
; VI-NEXT:    s_mul_i32 s4, s8, s15
; VI-NEXT:    v_mad_u64_u32 v[3:4], s[2:3], s13, v3, v[1:2]
; VI-NEXT:    s_mul_i32 s5, s9, s14
; VI-NEXT:    v_mov_b32_e32 v7, s12
; VI-NEXT:    v_mov_b32_e32 v1, v3
; VI-NEXT:    v_mad_u64_u32 v[1:2], s[2:3], s12, v8, v[1:2]
; VI-NEXT:    v_mov_b32_e32 v3, s14
; VI-NEXT:    v_mad_u64_u32 v[5:6], s[2:3], s8, v3, 0
; VI-NEXT:    v_add_u32_e32 v2, vcc, v4, v2
; VI-NEXT:    v_addc_u32_e64 v3, s[2:3], 0, 0, vcc
; VI-NEXT:    v_add_u32_e32 v4, vcc, s4, v6
; VI-NEXT:    v_add_u32_e32 v6, vcc, s5, v4
; VI-NEXT:    v_mad_u64_u32 v[4:5], s[2:3], s10, v7, v[5:6]
; VI-NEXT:    v_mad_u64_u32 v[2:3], s[2:3], s13, v8, v[2:3]
; VI-NEXT:    s_mul_i32 s6, s11, s12
; VI-NEXT:    s_mul_i32 s7, s10, s13
...
; GFX12:       ; %bb.0: ; %entry
; GFX12-NEXT:    s_clause 0x1
; GFX12-NEXT:    s_load_b128 s[0:3], s[4:5], 0x7c
...
; GFX12-NEXT:    s_mov_b32 s19, s7
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_mov_b32 s6, s0
; GFX12-NEXT:    s_mul_u64 s[2:3], s[2:3], s[8:9]
; GFX12-NEXT:    s_mov_b32 s12, s9
; GFX12-NEXT:    s_mov_b32 s9, s7
; GFX12-NEXT:    s_mul_u64 s[16:17], s[12:13], s[6:7]
; GFX12-NEXT:    s_mul_u64 s[14:15], s[8:9], s[6:7]
; GFX12-NEXT:    s_mul_u64 s[10:11], s[0:1], s[10:11]
; GFX12-NEXT:    s_mov_b32 s6, s15
; GFX12-NEXT:    s_mov_b32 s0, s1
; GFX12-NEXT:    s_mov_b32 s1, s7
; GFX12-NEXT:    s_add_nc_u64 s[16:17], s[16:17], s[6:7]
; GFX12-NEXT:    s_mul_u64 s[8:9], s[8:9], s[0:1]
; GFX12-NEXT:    s_mov_b32 s6, s17
; GFX12-NEXT:    s_mov_b32 s17, s7
; GFX12-NEXT:    s_add_nc_u64 s[2:3], s[2:3], s[10:11]
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[8:9], s[16:17]
; GFX12-NEXT:    s_mul_u64 s[0:1], s[12:13], s[0:1]
; GFX12-NEXT:    s_mov_b32 s18, s9
; GFX12-NEXT:    s_mov_b32 s11, s8
; GFX12-NEXT:    s_add_nc_u64 s[8:9], s[6:7], s[18:19]
; GFX12-NEXT:    s_mov_b32 s15, s7
; GFX12-NEXT:    s_mov_b32 s10, s7
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[8:9]
; GFX12-NEXT:    s_or_b64 s[6:7], s[14:15], s[10:11]
; GFX12-NEXT:    s_add_nc_u64 s[0:1], s[0:1], s[2:3]
; GFX12-NEXT:    s_delay_alu instid0(SALU_CYCLE_1)
; GFX12-NEXT:    v_dual_mov_b32 v1, s7 :: v_dual_mov_b32 v2, s0
