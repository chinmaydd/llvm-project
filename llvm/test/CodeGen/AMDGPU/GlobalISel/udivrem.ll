...
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v2
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v3, v0
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, v4, v1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v1, s9, v0
; GFX8-NEXT:    v_mul_lo_u32 v2, s8, v3
; GFX8-NEXT:    v_mul_hi_u32 v4, s8, v0
...
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v2, v1
; GFX8-NEXT:    v_cvt_f32_u32_e32 v2, s15
; GFX8-NEXT:    v_mul_lo_u32 v1, s9, v3
; GFX8-NEXT:    v_mul_hi_u32 v6, s8, v3
; GFX8-NEXT:    v_mul_hi_u32 v12, s9, v3
...
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_mul_f32_e32 v0, 0x5f7ffffc, v2
; GFX8-NEXT:    v_mul_f32_e32 v1, 0x2f800000, v0
...
; GFX8-NEXT:    v_cvt_u32_f32_e32 v9, v1
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v5, v6
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[0:1], s2, v8, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v7, v2
; GFX8-NEXT:    v_mul_lo_u32 v7, v9, v0
; GFX8-NEXT:    v_mul_hi_u32 v10, v8, v0
; GFX8-NEXT:    v_mul_hi_u32 v11, v9, v0
; GFX8-NEXT:    v_mov_b32_e32 v0, v1
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s2, v9, v[0:1]
; GFX8-NEXT:    v_add_u32_e32 v0, vcc, v5, v4
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[0:1], s3, v8, v[1:2]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v6, v4
; GFX8-NEXT:    v_mul_lo_u32 v4, v8, v1
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s12, v0, 0
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v7, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v4, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_mul_lo_u32 v7, v9, v1
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v5, v4
; GFX8-NEXT:    v_mul_hi_u32 v5, v8, v1
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v7, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v7, v5
; GFX8-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v10, v7
; GFX8-NEXT:    v_mul_hi_u32 v1, v9, v1
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v5, v4
; GFX8-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v5, vcc, v7, v5
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v1, v5
; GFX8-NEXT:    v_add_u32_e32 v7, vcc, v8, v4
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v7, 0
; GFX8-NEXT:    v_addc_u32_e32 v8, vcc, v9, v1, vcc
; GFX8-NEXT:    v_mov_b32_e32 v1, v3
; GFX8-NEXT:    v_mov_b32_e32 v3, v5
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, v12, v6
; GFX8-NEXT:    v_mul_lo_u32 v10, v8, v4
; GFX8-NEXT:    v_mul_hi_u32 v11, v7, v4
; GFX8-NEXT:    v_mul_hi_u32 v12, v8, v4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s2, v8, v[3:4]
; GFX8-NEXT:    v_mad_u64_u32 v[5:6], s[0:1], s12, v9, v[1:2]
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s3, v7, v[3:4]
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s13, v0, v[5:6]
; GFX8-NEXT:    v_mul_lo_u32 v1, v7, v3
; GFX8-NEXT:    v_mov_b32_e32 v5, s13
; GFX8-NEXT:    v_sub_u32_e32 v6, vcc, s9, v4
...
; GFX8-NEXT:    v_add_u32_e32 v1, vcc, v10, v1
; GFX8-NEXT:    v_mul_hi_u32 v10, v7, v3
...
; GFX8-NEXT:    v_mul_lo_u32 v10, s10, v3
; GFX8-NEXT:    v_mul_lo_u32 v12, s11, v3
; GFX8-NEXT:    v_mul_hi_u32 v13, s10, v3
; GFX8-NEXT:    v_mul_hi_u32 v14, s11, v3
; GFX8-NEXT:    v_mov_b32_e32 v3, s9
; GFX8-NEXT:    v_sub_u32_e32 v15, vcc, s8, v2
; GFX8-NEXT:    v_subb_u32_e64 v16, s[0:1], v3, v4, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s13, v16
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s12, v15
; GFX8-NEXT:    v_subb_u32_e32 v6, vcc, v6, v5, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s13, v16
; GFX8-NEXT:    v_subrev_u32_e32 v18, vcc, s12, v15
; GFX8-NEXT:    v_cndmask_b32_e64 v17, v2, v3, s[0:1]
; GFX8-NEXT:    v_subbrev_u32_e64 v19, s[0:1], 0, v6, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s13, v19
; GFX8-NEXT:    v_mul_lo_u32 v8, s11, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s12, v18
; GFX8-NEXT:    v_mul_hi_u32 v11, s10, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s13, v19
; GFX8-NEXT:    v_cndmask_b32_e64 v20, v2, v3, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v21, s[0:1], 1, v0
; GFX8-NEXT:    v_addc_u32_e64 v22, s[0:1], 0, v9, s[0:1]
; GFX8-NEXT:    v_mul_hi_u32 v1, s11, v1
; GFX8-NEXT:    v_add_u32_e64 v2, s[0:1], v8, v10
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v2, s[0:1], v2, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v2, s[0:1], v3, v2
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v12, v1
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v1, v13
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v4, s[0:1], v3, v4
; GFX8-NEXT:    v_add_u32_e64 v10, s[0:1], v1, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v1, 0, 1, s[0:1]
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s14, v10, 0
; GFX8-NEXT:    v_add_u32_e64 v1, s[0:1], v4, v1
; GFX8-NEXT:    v_add_u32_e64 v12, s[0:1], v14, v1
; GFX8-NEXT:    v_mov_b32_e32 v1, v3
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s14, v12, v[1:2]
; GFX8-NEXT:    v_subb_u32_e32 v1, vcc, v6, v5, vcc
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s15, v10, v[3:4]
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, 1, v21
; GFX8-NEXT:    v_sub_u32_e64 v6, s[0:1], s11, v3
; GFX8-NEXT:    v_addc_u32_e32 v5, vcc, 0, v22, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v8, s[0:1], s12, v18
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v20
; GFX8-NEXT:    v_subbrev_u32_e64 v11, s[0:1], 0, v1, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v21, v4, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v17
; GFX8-NEXT:    v_mov_b32_e32 v7, s11
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v22, v5, vcc
; GFX8-NEXT:    v_cndmask_b32_e64 v0, v0, v4, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v18, v8, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v19, v11, vcc
; GFX8-NEXT:    v_sub_u32_e32 v13, vcc, s10, v2
; GFX8-NEXT:    v_cndmask_b32_e64 v1, v9, v1, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v4, v15, v4, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v5, v16, v5, s[0:1]
; GFX8-NEXT:    v_subb_u32_e64 v7, s[0:1], v7, v3, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s15, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s14, v13
; GFX8-NEXT:    v_mov_b32_e32 v8, s15
; GFX8-NEXT:    v_cndmask_b32_e64 v3, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s15, v7
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v2, v3, s[0:1]
; GFX8-NEXT:    v_subb_u32_e32 v3, vcc, v6, v8, vcc
; GFX8-NEXT:    v_subrev_u32_e32 v6, vcc, s14, v13
; GFX8-NEXT:    v_subbrev_u32_e64 v14, s[0:1], 0, v3, vcc
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s15, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v9, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s14, v6
; GFX8-NEXT:    v_cndmask_b32_e64 v11, 0, -1, s[0:1]
; GFX8-NEXT:    v_cmp_eq_u32_e64 s[0:1], s15, v14
; GFX8-NEXT:    v_cndmask_b32_e64 v9, v9, v11, s[0:1]
; GFX8-NEXT:    v_add_u32_e64 v11, s[0:1], 1, v10
; GFX8-NEXT:    v_subb_u32_e32 v3, vcc, v3, v8, vcc
; GFX8-NEXT:    v_addc_u32_e64 v15, s[0:1], 0, v12, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v8, vcc, 1, v11
; GFX8-NEXT:    v_addc_u32_e32 v16, vcc, 0, v15, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v9
; GFX8-NEXT:    v_cndmask_b32_e32 v15, v15, v16, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v16, s[2:3], s14, v6
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v11, v8, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v2
; GFX8-NEXT:    v_mov_b32_e32 v9, s5
; GFX8-NEXT:    v_subbrev_u32_e64 v17, s[2:3], 0, v3, s[2:3]
; GFX8-NEXT:    v_mov_b32_e32 v8, s4
; GFX8-NEXT:    v_cndmask_b32_e64 v2, v10, v11, s[0:1]
; GFX8-NEXT:    v_mov_b32_e32 v11, s7
; GFX8-NEXT:    v_cndmask_b32_e64 v3, v12, v15, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v6, v6, v16, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v12, v14, v17, vcc
; GFX8-NEXT:    v_mov_b32_e32 v10, s6
; GFX8-NEXT:    v_cndmask_b32_e64 v6, v13, v6, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e64 v7, v7, v12, s[0:1]
...
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s5, v2, v[4:5]
; GFX9-NEXT:    v_mov_b32_e32 v6, s5
; GFX9-NEXT:    v_subb_co_u32_e64 v0, s[0:1], v7, v4, vcc
...
; GFX9-NEXT:    v_cvt_f32_u32_e32 v5, s7
; GFX9-NEXT:    v_sub_u32_e32 v4, s17, v4
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v4, v6, vcc
; GFX9-NEXT:    v_mul_f32_e32 v4, 0x4f800000, v5
; GFX9-NEXT:    v_add_f32_e32 v4, v4, v8
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v4, v4
; GFX9-NEXT:    v_subrev_co_u32_e32 v8, vcc, s4, v1
; GFX9-NEXT:    v_subbrev_co_u32_e64 v10, s[0:1], 0, v9, vcc
; GFX9-NEXT:    v_mul_f32_e32 v4, 0x5f7ffffc, v4
; GFX9-NEXT:    v_mul_f32_e32 v5, 0x2f800000, v4
; GFX9-NEXT:    v_trunc_f32_e32 v5, v5
; GFX9-NEXT:    v_mul_f32_e32 v11, 0xcf800000, v5
; GFX9-NEXT:    v_add_f32_e32 v4, v11, v4
; GFX9-NEXT:    v_cvt_u32_f32_e32 v11, v4
; GFX9-NEXT:    v_cvt_u32_f32_e32 v12, v5
; GFX9-NEXT:    v_subb_co_u32_e32 v6, vcc, v9, v6, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v11, 0
; GFX9-NEXT:    v_add_co_u32_e64 v13, s[0:1], 1, v2
; GFX9-NEXT:    v_mul_lo_u32 v15, v12, v4
; GFX9-NEXT:    v_mul_hi_u32 v16, v11, v4
; GFX9-NEXT:    v_mul_hi_u32 v17, v12, v4
; GFX9-NEXT:    v_mov_b32_e32 v4, v5
; GFX9-NEXT:    v_addc_co_u32_e64 v14, s[0:1], 0, v3, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v12, v[4:5]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s5, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v18, 0, -1, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s3, v11, v[4:5]
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s4, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s5, v10
; GFX9-NEXT:    v_cndmask_b32_e64 v18, v18, v5, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v5, v11, v4
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v15, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v15, v12, v4
; GFX9-NEXT:    v_add_u32_e32 v5, v9, v5
; GFX9-NEXT:    v_mul_hi_u32 v9, v11, v4
; GFX9-NEXT:    v_mul_hi_u32 v4, v12, v4
; GFX9-NEXT:    v_add_co_u32_e32 v15, vcc, v15, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v15, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v15, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v15, v16, v15
; GFX9-NEXT:    v_add_co_u32_e32 v16, vcc, 1, v13
; GFX9-NEXT:    v_addc_co_u32_e32 v17, vcc, 0, v14, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v9, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v4, v15, v9, v4
; GFX9-NEXT:    v_add_co_u32_e32 v9, vcc, v11, v5
; GFX9-NEXT:    v_addc_co_u32_e32 v11, vcc, v12, v4, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v9, 0
; GFX9-NEXT:    v_subrev_co_u32_e32 v12, vcc, s4, v8
; GFX9-NEXT:    v_subbrev_co_u32_e32 v6, vcc, 0, v6, vcc
; GFX9-NEXT:    v_mul_lo_u32 v15, v11, v4
; GFX9-NEXT:    v_mul_hi_u32 v19, v9, v4
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v18
; GFX9-NEXT:    v_mul_hi_u32 v18, v11, v4
; GFX9-NEXT:    v_mov_b32_e32 v4, v5
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s2, v11, v[4:5]
; GFX9-NEXT:    v_cndmask_b32_e32 v13, v13, v16, vcc
; GFX9-NEXT:    v_cndmask_b32_e32 v14, v14, v17, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[0:1], s3, v9, v[4:5]
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v7
; GFX9-NEXT:    v_cndmask_b32_e32 v7, v8, v12, vcc
; GFX9-NEXT:    v_mul_lo_u32 v5, v9, v4
; GFX9-NEXT:    v_cndmask_b32_e32 v8, v10, v6, vcc
; GFX9-NEXT:    v_mul_lo_u32 v10, v11, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v2, v2, v13, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v15, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v6, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v19
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v5, v6, v5
; GFX9-NEXT:    v_mul_hi_u32 v6, v9, v4
; GFX9-NEXT:    v_add_co_u32_e32 v10, vcc, v10, v18
...
; GFX9-NEXT:    v_mul_lo_u32 v10, s18, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v1, v7, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v1, s18, v5
...
; GFX9-NEXT:    v_mul_hi_u32 v12, s19, v4
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v7, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v10, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v5, vcc, v5, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v11, vcc, v5, v1
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[2:3], s6, v11, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v7, v0, v8, s[0:1]
; GFX9-NEXT:    v_add_u32_e32 v0, v10, v9
...
; GFX10-NEXT:    v_add_co_u32 v4, s10, v13, v4
...
; GFX10-NEXT:    v_add_co_u32 v6, s10, v6, v11
; GFX10-NEXT:    v_cndmask_b32_e64 v6, 0, 1, s10
; GFX10-NEXT:    v_add_co_u32 v4, s10, v4, v14
...
; GFX10-NEXT:    v_add_co_u32 v4, s10, v4, v6
