...
; GFX8-NEXT:    v_xor_b32_e32 v5, s7, v5
; GFX8-NEXT:    v_subrev_u32_e32 v5, vcc, s7, v5
...
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], s10, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], s10, v4, v[1:2]
; GFX9-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], s11, v3, v[1:2]
...
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[8:9], s6, v5, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX9-NEXT:    v_add3_u32 v3, v3, v2, v6
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], s6, v3, v[1:2]
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s0, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[8:9], s7, v5, v[1:2]
...
; GFX8-NEXT:    s_xor_b64 s[0:1], s[10:11], s[4:5]
; GFX8-NEXT:    v_mul_f32_e32 v0, 0x4f800000, v0
; GFX8-NEXT:    v_add_f32_e32 v0, v0, v1
; GFX8-NEXT:    v_rcp_iflag_f32_e32 v0, v0
...
; GFX8-NEXT:    s_mov_b32 s9, s8
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s16, v3, 0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s16, v4, v[1:2]
; GFX8-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX8-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s17, v3, v[1:2]
; GFX8-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX8-NEXT:    v_mul_hi_u32 v0, v4, v0
; GFX8-NEXT:    v_mul_lo_u32 v6, v3, v1
; GFX8-NEXT:    v_mul_lo_u32 v7, v4, v1
...
; GFX8-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s6, v3, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v2, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v4, v2
; GFX8-NEXT:    v_add_u32_e32 v2, vcc, v5, v2
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[10:11], s6, v2, v[1:2]
; GFX8-NEXT:    v_mov_b32_e32 v1, s1
; GFX8-NEXT:    v_mad_u64_u32 v[4:5], s[10:11], s7, v3, v[4:5]
...
; GFX8-NEXT:    v_cvt_f32_u32_e32 v7, s17
; GFX8-NEXT:    v_cvt_f32_u32_e32 v13, s16
...
; GFX8-NEXT:    s_subb_u32 s7, 0, s17
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX8-NEXT:    v_mad_u64_u32 v[6:7], s[0:1], s7, v14, v[6:7]
; GFX8-NEXT:    v_cndmask_b32_e32 v7, v11, v16, vcc
; GFX8-NEXT:    v_cndmask_b32_e32 v11, v12, v17, vcc
; GFX8-NEXT:    v_mul_lo_u32 v12, v14, v6
; GFX8-NEXT:    v_subrev_u32_e64 v13, s[0:1], s6, v4
; GFX8-NEXT:    v_subbrev_u32_e64 v8, s[0:1], 0, v8, s[0:1]
...
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v13, vcc
...
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s7, v10, v[2:3]
...
; GFX8-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s16, v7, 0
; GFX8-NEXT:    v_cndmask_b32_e64 v4, 0, 1, vcc
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, v6, v4
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, v9, v4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s16, v6, v[3:4]
; GFX8-NEXT:    v_xor_b32_e32 v5, s4, v5
; GFX8-NEXT:    v_mov_b32_e32 v9, s4
; GFX8-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s17, v7, v[3:4]
...
; GFX8-NEXT:    v_cmp_le_u32_e64 s[0:1], s16, v11
; GFX8-NEXT:    v_cndmask_b32_e64 v14, 0, -1, s[0:1]
...
; GFX8-NEXT:    v_addc_u32_e64 v15, s[0:1], 0, v6, s[0:1]
; GFX8-NEXT:    v_add_u32_e32 v9, vcc, 1, v14
; GFX8-NEXT:    v_addc_u32_e32 v16, vcc, 0, v15, vcc
; GFX8-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX8-NEXT:    v_subrev_u32_e64 v13, s[0:1], s16, v11
; GFX8-NEXT:    v_subbrev_u32_e64 v8, s[0:1], 0, v8, s[0:1]
; GFX8-NEXT:    v_cndmask_b32_e32 v9, v14, v9, vcc
...
; GFX8-NEXT:    v_xor_b32_e32 v7, s8, v8
...
; GFX9-NEXT:    v_cvt_u32_f32_e32 v3, v0
; GFX9-NEXT:    v_cvt_u32_f32_e32 v4, v2
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s16, v3, 0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s16, v4, v[1:2]
; GFX9-NEXT:    v_mul_hi_u32 v5, v3, v0
; GFX9-NEXT:    v_mad_u64_u32 v[1:2], s[10:11], s17, v3, v[1:2]
; GFX9-NEXT:    v_mul_lo_u32 v2, v4, v0
; GFX9-NEXT:    v_mul_hi_u32 v0, v4, v0
; GFX9-NEXT:    v_mul_lo_u32 v6, v3, v1
; GFX9-NEXT:    v_mul_lo_u32 v7, v4, v1
...
; GFX9-NEXT:    v_mul_hi_u32 v0, v4, v0
; GFX9-NEXT:    v_mul_lo_u32 v5, v3, v1
; GFX9-NEXT:    s_xor_b64 s[16:17], s[4:5], s[8:9]
...
; GFX9-NEXT:    v_mad_u64_u32 v[0:1], s[10:11], s6, v2, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v5, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v3, v4, v3
; GFX9-NEXT:    v_add3_u32 v3, v3, v5, v6
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[10:11], s6, v3, v[1:2]
; GFX9-NEXT:    v_mov_b32_e32 v1, s1
; GFX9-NEXT:    v_sub_co_u32_e32 v0, vcc, s0, v0
; GFX9-NEXT:    v_mad_u64_u32 v[4:5], s[10:11], s7, v2, v[4:5]
; GFX9-NEXT:    s_ashr_i32 s10, s3, 31
; GFX9-NEXT:    s_add_u32 s18, s18, s8
; GFX9-NEXT:    v_sub_u32_e32 v5, s1, v4
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s7, v1
; GFX9-NEXT:    v_subb_co_u32_e32 v10, vcc, v5, v9, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v4, v6, s[0:1]
; GFX9-NEXT:    v_subrev_co_u32_e32 v4, vcc, s6, v0
; GFX9-NEXT:    v_subbrev_co_u32_e64 v5, s[0:1], 0, v10, vcc
; GFX9-NEXT:    s_addc_u32 s19, s19, s8
; GFX9-NEXT:    s_add_u32 s0, s2, s10
; GFX9-NEXT:    s_mov_b32 s11, s10
; GFX9-NEXT:    s_addc_u32 s1, s3, s10
; GFX9-NEXT:    s_xor_b64 s[2:3], s[0:1], s[10:11]
; GFX9-NEXT:    v_cvt_f32_u32_e32 v8, s3
; GFX9-NEXT:    v_cvt_f32_u32_e32 v7, s2
; GFX9-NEXT:    v_add_co_u32_e64 v11, s[0:1], 1, v2
; GFX9-NEXT:    v_mul_f32_e32 v8, 0x4f800000, v8
; GFX9-NEXT:    v_add_f32_e32 v7, v8, v7
; GFX9-NEXT:    v_rcp_iflag_f32_e32 v7, v7
; GFX9-NEXT:    v_addc_co_u32_e64 v12, s[0:1], 0, v3, s[0:1]
; GFX9-NEXT:    s_xor_b64 s[18:19], s[18:19], s[8:9]
; GFX9-NEXT:    v_mul_f32_e32 v7, 0x5f7ffffc, v7
; GFX9-NEXT:    v_mul_f32_e32 v8, 0x2f800000, v7
; GFX9-NEXT:    v_trunc_f32_e32 v8, v8
; GFX9-NEXT:    v_mul_f32_e32 v14, 0xcf800000, v8
; GFX9-NEXT:    v_add_f32_e32 v7, v14, v7
...
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s5, v14, 0
; GFX9-NEXT:    v_cmp_le_u32_e64 s[0:1], s6, v4
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, -1, s[0:1]
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s7, v5
; GFX9-NEXT:    v_cndmask_b32_e64 v13, v13, v16, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v16, v15, v7
; GFX9-NEXT:    v_mul_hi_u32 v17, v14, v7
; GFX9-NEXT:    v_mul_hi_u32 v18, v15, v7
; GFX9-NEXT:    v_mov_b32_e32 v7, v8
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s5, v15, v[7:8]
; GFX9-NEXT:    s_subb_u32 s20, 0, s3
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v10, v9, vcc
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s20, v14, v[7:8]
; GFX9-NEXT:    v_add_co_u32_e32 v8, vcc, 1, v11
; GFX9-NEXT:    v_addc_co_u32_e32 v10, vcc, 0, v12, vcc
; GFX9-NEXT:    v_cmp_ne_u32_e32 vcc, 0, v13
; GFX9-NEXT:    v_cndmask_b32_e32 v11, v11, v8, vcc
; GFX9-NEXT:    v_mul_lo_u32 v8, v14, v7
; GFX9-NEXT:    v_subrev_co_u32_e64 v13, s[0:1], s6, v4
; GFX9-NEXT:    v_subbrev_co_u32_e64 v9, s[0:1], 0, v9, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v8, s[0:1], v16, v8
; GFX9-NEXT:    v_cndmask_b32_e32 v10, v12, v10, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v8, s[0:1], v8, v17
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, s[0:1]
; GFX9-NEXT:    v_mul_lo_u32 v16, v15, v7
; GFX9-NEXT:    v_add_u32_e32 v8, v12, v8
; GFX9-NEXT:    v_mul_hi_u32 v12, v14, v7
; GFX9-NEXT:    v_mul_hi_u32 v7, v15, v7
; GFX9-NEXT:    v_add_co_u32_e64 v16, s[0:1], v16, v18
; GFX9-NEXT:    v_cndmask_b32_e64 v17, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[0:1], v16, v12
; GFX9-NEXT:    v_cndmask_b32_e64 v16, 0, 1, s[0:1]
; GFX9-NEXT:    v_add_co_u32_e64 v8, s[0:1], v12, v8
; GFX9-NEXT:    v_add_u32_e32 v16, v17, v16
; GFX9-NEXT:    v_cndmask_b32_e64 v12, 0, 1, s[0:1]
; GFX9-NEXT:    v_add3_u32 v7, v16, v12, v7
; GFX9-NEXT:    v_add_co_u32_e64 v12, s[0:1], v14, v8
; GFX9-NEXT:    v_addc_co_u32_e64 v14, s[0:1], v15, v7, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[7:8], s[0:1], s5, v12, 0
; GFX9-NEXT:    v_cmp_ne_u32_e64 s[0:1], 0, v6
; GFX9-NEXT:    v_cndmask_b32_e64 v6, v2, v11, s[0:1]
; GFX9-NEXT:    v_mov_b32_e32 v2, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v3, v10, s[0:1]
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], s5, v14, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e32 v5, v5, v9, vcc
; GFX9-NEXT:    v_mul_lo_u32 v11, v14, v7
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[6:7], s20, v12, v[2:3]
; GFX9-NEXT:    v_cndmask_b32_e64 v5, v1, v5, s[0:1]
; GFX9-NEXT:    v_mul_hi_u32 v15, v12, v7
; GFX9-NEXT:    v_mul_lo_u32 v1, v12, v2
; GFX9-NEXT:    v_cndmask_b32_e32 v4, v4, v13, vcc
; GFX9-NEXT:    v_mul_hi_u32 v7, v14, v7
; GFX9-NEXT:    v_mul_lo_u32 v9, v14, v2
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v11, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v1, vcc, v1, v15
; GFX9-NEXT:    v_cndmask_b32_e64 v1, 0, 1, vcc
; GFX9-NEXT:    v_add_u32_e32 v1, v8, v1
; GFX9-NEXT:    v_mul_hi_u32 v8, v12, v2
...
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add3_u32 v2, v8, v7, v2
; GFX9-NEXT:    v_add_co_u32_e32 v7, vcc, v12, v1
; GFX9-NEXT:    v_cndmask_b32_e64 v4, v0, v4, s[0:1]
; GFX9-NEXT:    v_xor_b32_e32 v0, s16, v6
; GFX9-NEXT:    v_addc_co_u32_e32 v2, vcc, v14, v2, vcc
; GFX9-NEXT:    v_xor_b32_e32 v3, s17, v10
; GFX9-NEXT:    v_mov_b32_e32 v6, s17
; GFX9-NEXT:    v_mul_lo_u32 v8, s19, v7
; GFX9-NEXT:    v_mul_lo_u32 v9, s18, v2
; GFX9-NEXT:    v_subrev_co_u32_e32 v0, vcc, s16, v0
; GFX9-NEXT:    v_subb_co_u32_e32 v1, vcc, v3, v6, vcc
; GFX9-NEXT:    v_mul_hi_u32 v3, s18, v7
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v8, v9
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v3, vcc, v6, v3
; GFX9-NEXT:    v_cndmask_b32_e64 v3, 0, 1, vcc
; GFX9-NEXT:    v_mul_lo_u32 v6, s19, v2
; GFX9-NEXT:    v_mul_hi_u32 v7, s19, v7
; GFX9-NEXT:    v_add_u32_e32 v3, v8, v3
; GFX9-NEXT:    v_mul_hi_u32 v8, s18, v2
; GFX9-NEXT:    v_mul_hi_u32 v10, s19, v2
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v7
; GFX9-NEXT:    v_cndmask_b32_e64 v7, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v8
; GFX9-NEXT:    v_cndmask_b32_e64 v8, 0, 1, vcc
; GFX9-NEXT:    v_add_co_u32_e32 v6, vcc, v6, v3
; GFX9-NEXT:    v_mad_u64_u32 v[2:3], s[0:1], s2, v6, 0
; GFX9-NEXT:    v_cndmask_b32_e64 v9, 0, 1, vcc
; GFX9-NEXT:    v_xor_b32_e32 v11, s4, v4
; GFX9-NEXT:    v_add_u32_e32 v4, v7, v8
; GFX9-NEXT:    v_add3_u32 v7, v4, v9, v10
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s2, v7, v[3:4]
; GFX9-NEXT:    v_xor_b32_e32 v5, s4, v5
; GFX9-NEXT:    v_mov_b32_e32 v8, s4
; GFX9-NEXT:    v_mad_u64_u32 v[3:4], s[0:1], s3, v6, v[3:4]
; GFX9-NEXT:    v_subrev_co_u32_e32 v4, vcc, s4, v11
; GFX9-NEXT:    v_subb_co_u32_e32 v5, vcc, v5, v8, vcc
; GFX9-NEXT:    v_mov_b32_e32 v10, s19
; GFX9-NEXT:    v_sub_co_u32_e32 v2, vcc, s18, v2
; GFX9-NEXT:    v_sub_u32_e32 v9, s19, v3
; GFX9-NEXT:    v_subb_co_u32_e64 v3, s[0:1], v10, v3, vcc
...
; GFX9-NEXT:    v_cmp_eq_u32_e64 s[0:1], s3, v3
; GFX9-NEXT:    v_subb_co_u32_e32 v9, vcc, v9, v8, vcc
; GFX9-NEXT:    v_cndmask_b32_e64 v10, v10, v11, s[0:1]
; GFX9-NEXT:    v_subrev_co_u32_e32 v11, vcc, s2, v2
; GFX9-NEXT:    v_subbrev_co_u32_e64 v12, s[0:1], 0, v9, vcc
...
; GFX9-NEXT:    v_add_co_u32_e64 v14, s[0:1], 1, v6
; GFX9-NEXT:    v_subb_co_u32_e32 v8, vcc, v9, v8, vcc
; GFX9-NEXT:    v_addc_co_u32_e64 v15, s[0:1], 0, v7, s[0:1]
...
; GFX9-NEXT:    v_subbrev_co_u32_e64 v8, s[0:1], 0, v8, s[0:1]
...
; GFX9-NEXT:    v_cndmask_b32_e64 v8, v3, v8, s[0:1]
; GFX9-NEXT:    s_xor_b64 s[0:1], s[8:9], s[10:11]
; GFX9-NEXT:    v_xor_b32_e32 v2, s0, v6
; GFX9-NEXT:    v_xor_b32_e32 v3, s1, v7
...
; GFX9-NEXT:    v_xor_b32_e32 v7, s8, v8
...
; GFX10-NEXT:    v_mul_hi_u32 v5, s19, v6
...
; GFX10-NEXT:    global_store_dwordx4 v14, v[0:3], s[12:13]
; GFX10-NEXT:    global_store_dwordx4 v14, v[4:7], s[14:15]
; GFX10-NEXT:    s_endpgm
...
; GFX8-NEXT:    v_mul_lo_u32 v5, v4, s6
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-NEXT:    v_sub_u32_e32 v5, vcc, s4, v5
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s6, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v6, s[0:1], s6, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v5, v5, v6, vcc
; GFX8-NEXT:    v_add_u32_e32 v6, vcc, 1, v4
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s6, v5
; GFX8-NEXT:    v_cndmask_b32_e32 v4, v4, v6, vcc
...
; GFX8-NEXT:    v_subrev_u32_e32 v4, vcc, s11, v2
; GFX8-NEXT:    v_sub_u32_e32 v2, vcc, s1, v3
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, 1, v1
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s13, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
; GFX8-NEXT:    v_subrev_u32_e64 v3, s[0:1], s13, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v2, v2, v3, vcc
; GFX8-NEXT:    v_add_u32_e32 v3, vcc, 1, v1
; GFX8-NEXT:    v_cmp_le_u32_e32 vcc, s13, v2
; GFX8-NEXT:    v_cndmask_b32_e32 v1, v1, v3, vcc
