...
; GFX9-NEXT:    s_and_b32 s8, 0xffff, s1
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    s_and_b32 s9, 0xffff, s2
...
; GFX9-NEXT:    v_mov_b32_e32 v0, s0
; GFX9-NEXT:    s_and_b32 s10, 0xffff, s3
...
; GFX7-NEXT:    s_bfe_u32 s11, s2, 0x80008
; GFX7-NEXT:    ds_write_b8 v4, v0 offset:6
; GFX7-NEXT:    v_mov_b32_e32 v0, s1
; GFX7-NEXT:    s_lshr_b32 s10, s2, 16
...
; GFX7-NEXT:    s_bfe_u32 s13, s3, 0x80008
; GFX7-NEXT:    ds_write_b8 v4, v0 offset:10
; GFX7-NEXT:    v_mov_b32_e32 v0, s2
; GFX7-NEXT:    s_lshr_b32 s12, s3, 16
...
; GFX10-NEXT:    s_and_b32 s8, 0xffff, s1
...
; GFX10-NEXT:    s_and_b32 s10, 0xffff, s3
; GFX10-NEXT:    v_mov_b32_e32 v2, s3
; GFX10-NEXT:    s_lshr_b32 s3, s4, 8
; GFX10-NEXT:    v_mov_b32_e32 v5, s4
; GFX10-NEXT:    s_lshr_b32 s4, s8, 8
; GFX10-NEXT:    s_lshr_b32 s5, s7, 8
; GFX10-NEXT:    v_mov_b32_e32 v7, s0
; GFX10-NEXT:    v_mov_b32_e32 v6, s7
; GFX10-NEXT:    v_mov_b32_e32 v8, s3
; GFX10-NEXT:    s_lshr_b32 s6, s9, 8
...
; GFX11-NEXT:    s_and_b32 s8, 0xffff, s1
...
; GFX11-NEXT:    s_and_b32 s10, 0xffff, s3
; GFX11-NEXT:    s_lshr_b32 s3, s5, 8
; GFX11-NEXT:    v_dual_mov_b32 v6, s7 :: v_dual_mov_b32 v7, s0
; GFX11-NEXT:    s_lshr_b32 s4, s8, 8
; GFX11-NEXT:    s_lshr_b32 s5, s7, 8
; GFX11-NEXT:    s_lshr_b32 s6, s9, 8
; GFX11-NEXT:    v_dual_mov_b32 v8, s3 :: v_dual_mov_b32 v9, s4
...
; GFX11-NEXT:    v_dual_mov_b32 v0, s6 :: v_dual_mov_b32 v5, s0
...
; GFX11-NEXT:    s_lshr_b32 s1, s2, 16
; GFX11-NEXT:    s_lshr_b32 s2, s3, 16
; GFX11-NEXT:    v_dual_mov_b32 v6, s6 :: v_dual_mov_b32 v7, s1
...
; GFX11-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v0, s1 :: v_dual_mov_b32 v1, s2
; GFX11-NEXT:    v_dual_mov_b32 v2, s0 :: v_dual_mov_b32 v3, s4
