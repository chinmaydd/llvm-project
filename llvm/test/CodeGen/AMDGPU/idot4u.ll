...
; GFX8-NEXT:    v_and_b32_e32 v2, 0xff, v0
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mad_u32_u24 v3, v3, v5, s0
; GFX8-NEXT:    v_bfe_u32 v7, v0, 16, 8
; GFX8-NEXT:    v_mad_u32_u24 v1, v1, v2, v3
; GFX8-NEXT:    v_lshrrev_b32_e32 v0, 24, v0
; GFX8-NEXT:    v_mad_u32_u24 v1, v6, v7, v1
...
; GFX8-NEXT:    s_waitcnt lgkmcnt(0)
; GFX8-NEXT:    v_mad_u32_u24 v0, v4, v0, s0
...
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v6, 24, v1
; GFX11-DL-TRUE16-NEXT:    v_lshrrev_b32_e32 v7, 24, v2
; GFX11-DL-TRUE16-NEXT:    v_and_b16 v1.l, 0xff, v2.h
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_4) | instskip(NEXT) | instid1(VALU_DEP_4)
; GFX11-DL-TRUE16-NEXT:    v_pk_mul_lo_u16 v4, v4, v5
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v5.h, v6.l
; GFX11-DL-TRUE16-NEXT:    v_and_b16 v5.l, 0xff, v1.h
; GFX11-DL-TRUE16-NEXT:    v_mov_b16_e32 v1.h, v7.l
; GFX11-DL-TRUE16-NEXT:    s_waitcnt vmcnt(0)
; GFX11-DL-TRUE16-NEXT:    v_add_nc_u16 v0.l, v4.l, v0.l
; GFX11-DL-TRUE16-NEXT:    s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)
; GFX11-DL-TRUE16-NEXT:    v_pk_mul_lo_u16 v1, v5, v1
...
; GFX7-NEXT:    buffer_load_dword v0, v[1:2], s[4:7], 0 addr64
; GFX7-NEXT:    s_mov_b32 s2, -1
; GFX7-NEXT:    s_waitcnt vmcnt(1)
; GFX7-NEXT:    v_bfe_u32 v2, v3, 16, 8
...
; GFX8-NEXT:    v_add_u32_e32 v4, vcc, s0, v1
; GFX8-NEXT:    v_addc_u32_e32 v3, vcc, 0, v3, vcc
