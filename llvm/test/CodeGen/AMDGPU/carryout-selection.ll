...
; CISI-NEXT:    s_add_u32 s4, s2, s4
; CISI-NEXT:    s_addc_u32 s5, s3, s5
...
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
; CISI-NEXT:    s_mov_b32 s5, s3
; CISI-NEXT:    v_mov_b32_e32 v0, s9
; CISI-NEXT:    s_mov_b32 s4, s2
; CISI-NEXT:    s_mov_b32 s3, 0xf000
; CISI-NEXT:    s_mov_b32 s2, -1
...
; CISI-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0xd
; CISI-NEXT:    s_waitcnt lgkmcnt(0)
; CISI-NEXT:    s_sub_u32 s4, s2, s4
; CISI-NEXT:    s_subb_u32 s5, s3, s5
; CISI-NEXT:    v_mov_b32_e32 v0, s4
; CISI-NEXT:    s_mov_b32 s3, 0xf000
; CISI-NEXT:    s_mov_b32 s2, -1
; CISI-NEXT:    v_mov_b32_e32 v1, s5
