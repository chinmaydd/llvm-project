...
; VI-NEXT:    v_mov_b32_e32 v2, s2
; VI-NEXT:    v_mov_b32_e32 v3, s3
; VI-NEXT:    v_cvt_f32_f16_e32 v14, v1
; VI-NEXT:    v_cvt_f32_f16_e32 v12, v0
; VI-NEXT:    v_cvt_f32_f16_sdwa v15, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_sdwa v13, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    flat_store_dwordx4 v[2:3], v[8:11]
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_cvt_f32_f16_e32 v2, v7
; VI-NEXT:    v_cvt_f32_f16_e32 v0, v6
; VI-NEXT:    v_cvt_f32_f16_sdwa v3, v7 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_sdwa v1, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
...
; VI-NEXT:    flat_store_dwordx4 v[4:5], v[8:11]
; VI-NEXT:    s_endpgm
;
...
; CI-NEXT:    v_mov_b32_e32 v17, s7
; CI-NEXT:    v_mov_b32_e32 v16, s6
...
; CI-NEXT:    s_addc_u32 s7, s1, 0
; CI-NEXT:    v_mov_b32_e32 v9, s1
; CI-NEXT:    s_add_u32 s8, s0, 0x70
; CI-NEXT:    v_mov_b32_e32 v8, s0
; CI-NEXT:    s_addc_u32 s9, s1, 0
; CI-NEXT:    s_add_u32 s10, s0, 0x60
; CI-NEXT:    s_addc_u32 s11, s1, 0
; CI-NEXT:    s_add_u32 s12, s0, 0x50
; CI-NEXT:    s_addc_u32 s13, s1, 0
; CI-NEXT:    s_add_u32 s14, s0, 64
; CI-NEXT:    s_addc_u32 s15, s1, 0
; CI-NEXT:    s_waitcnt vmcnt(1)
; CI-NEXT:    v_lshrrev_b32_e32 v10, 16, v7
; CI-NEXT:    v_cvt_f32_f16_e32 v7, v7
; CI-NEXT:    v_lshrrev_b32_e32 v12, 16, v6
; CI-NEXT:    v_cvt_f32_f16_e32 v14, v6
; CI-NEXT:    v_cvt_f32_f16_e32 v6, v10
; CI-NEXT:    v_lshrrev_b32_e32 v15, 16, v5
; CI-NEXT:    v_cvt_f32_f16_e32 v16, v5
; CI-NEXT:    v_lshrrev_b32_e32 v17, 16, v4
; CI-NEXT:    v_cvt_f32_f16_e32 v18, v4
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v7
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v6
; CI-NEXT:    v_cvt_f32_f16_e32 v19, v12
; CI-NEXT:    v_mov_b32_e32 v11, s3
; CI-NEXT:    v_mov_b32_e32 v10, s2
; CI-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
; CI-NEXT:    v_mov_b32_e32 v13, s5
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v14
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v19
; CI-NEXT:    v_cvt_f32_f16_e32 v19, v15
; CI-NEXT:    v_mov_b32_e32 v12, s4
; CI-NEXT:    v_mov_b32_e32 v11, s7
; CI-NEXT:    flat_store_dwordx4 v[12:13], v[4:7]
; CI-NEXT:    v_mov_b32_e32 v10, s6
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v16
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v19
; CI-NEXT:    s_waitcnt vmcnt(2)
; CI-NEXT:    v_lshrrev_b32_e32 v19, 16, v3
; CI-NEXT:    v_cvt_f32_f16_e32 v20, v3
; CI-NEXT:    v_mov_b32_e32 v15, s9
; CI-NEXT:    flat_store_dwordx4 v[10:11], v[4:7]
; CI-NEXT:    v_lshrrev_b32_e32 v10, 16, v0
; CI-NEXT:    v_lshrrev_b32_e32 v4, 16, v2
; CI-NEXT:    v_cvt_f32_f16_e32 v6, v2
; CI-NEXT:    v_cvt_f32_f16_e32 v2, v17
; CI-NEXT:    v_lshrrev_b32_e32 v5, 16, v1
; CI-NEXT:    v_cvt_f32_f16_e32 v7, v1
; CI-NEXT:    v_cvt_f32_f16_e32 v11, v0
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v18
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v2
; CI-NEXT:    v_cvt_f32_f16_e32 v18, v19
; CI-NEXT:    v_cvt_f32_f16_e32 v19, v4
; CI-NEXT:    v_mov_b32_e32 v14, s8
; CI-NEXT:    flat_store_dwordx4 v[8:9], v[0:3]
; CI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v6
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v20
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v18
; CI-NEXT:    v_cvt_f32_f16_e32 v18, v5
; CI-NEXT:    v_cvt_f32_f16_e32 v20, v10
; CI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v11
; CI-NEXT:    v_cvt_f64_f32_e32 v[10:11], v19
; CI-NEXT:    flat_store_dwordx4 v[14:15], v[0:3]
; CI-NEXT:    v_mov_b32_e32 v13, s11
; CI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v7
; CI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v18
; CI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v20
; CI-NEXT:    v_mov_b32_e32 v12, s10
; CI-NEXT:    v_mov_b32_e32 v17, s13
; CI-NEXT:    v_mov_b32_e32 v14, s14
; CI-NEXT:    v_mov_b32_e32 v16, s12
; CI-NEXT:    v_mov_b32_e32 v15, s15
; CI-NEXT:    flat_store_dwordx4 v[12:13], v[8:11]
; CI-NEXT:    flat_store_dwordx4 v[16:17], v[0:3]
...
; VI-NEXT:    v_cvt_f32_f16_e32 v17, v6
; VI-NEXT:    v_cvt_f32_f16_sdwa v18, v6 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[7:8], v8
; VI-NEXT:    v_cvt_f64_f32_e32 v[9:10], v9
; VI-NEXT:    v_cvt_f32_f16_e32 v19, v4
; VI-NEXT:    v_cvt_f32_f16_sdwa v20, v4 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    flat_store_dwordx4 v[13:14], v[7:10]
; VI-NEXT:    s_nop 0
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v17
; VI-NEXT:    v_cvt_f64_f32_e32 v[8:9], v18
; VI-NEXT:    v_cvt_f32_f16_e32 v17, v5
; VI-NEXT:    v_cvt_f32_f16_sdwa v18, v5 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_mov_b32_e32 v14, s7
; VI-NEXT:    flat_store_dwordx4 v[15:16], v[6:9]
; VI-NEXT:    v_mov_b32_e32 v13, s6
; VI-NEXT:    v_cvt_f64_f32_e32 v[5:6], v17
; VI-NEXT:    v_cvt_f64_f32_e32 v[7:8], v18
...
; VI-NEXT:    v_cvt_f32_f16_e32 v8, v2
; VI-NEXT:    v_cvt_f64_f32_e32 v[4:5], v19
; VI-NEXT:    v_cvt_f64_f32_e32 v[6:7], v20
; VI-NEXT:    v_cvt_f32_f16_e32 v2, v1
; VI-NEXT:    v_cvt_f32_f16_sdwa v14, v1 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f32_f16_sdwa v19, v3 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    flat_store_dwordx4 v[11:12], v[4:7]
; VI-NEXT:    v_cvt_f64_f32_e32 v[1:2], v2
; VI-NEXT:    v_cvt_f32_f16_e32 v7, v3
; VI-NEXT:    v_cvt_f64_f32_e32 v[3:4], v14
; VI-NEXT:    v_cvt_f32_f16_e32 v11, v0
; VI-NEXT:    v_cvt_f32_f16_sdwa v12, v0 dst_sel:DWORD dst_unused:UNUSED_PAD src0_sel:WORD_1
; VI-NEXT:    v_cvt_f64_f32_e32 v[5:6], v8
; VI-NEXT:    flat_store_dwordx4 v[9:10], v[1:4]
; VI-NEXT:    v_cvt_f64_f32_e32 v[9:10], v11
; VI-NEXT:    v_cvt_f64_f32_e32 v[11:12], v12
; VI-NEXT:    v_cvt_f64_f32_e32 v[0:1], v7
; VI-NEXT:    v_cvt_f64_f32_e32 v[2:3], v19
; VI-NEXT:    v_cvt_f64_f32_e32 v[7:8], v13
; VI-NEXT:    v_mov_b32_e32 v15, s10
; VI-NEXT:    v_mov_b32_e32 v18, s13
...
; VI-NEXT:    flat_store_dwordx4 v[17:18], v[0:3]
; VI-NEXT:    flat_store_dwordx4 v[13:14], v[5:8]
; VI-NEXT:    s_endpgm
;
...
; CI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; CI-NEXT:    s_waitcnt vmcnt(1)
; CI-NEXT:    v_cvt_f16_f32_e32 v16, v11
; CI-NEXT:    v_cvt_f16_f32_e32 v18, v9
; CI-NEXT:    s_waitcnt vmcnt(0)
; CI-NEXT:    v_cvt_f16_f32_e32 v15, v15
; CI-NEXT:    v_cvt_f16_f32_e32 v13, v13
; CI-NEXT:    v_cvt_f16_f32_e32 v17, v10
; CI-NEXT:    v_cvt_f16_f32_e32 v19, v8
...
; CI-NEXT:    v_or_b32_e32 v2, v4, v5
; CI-NEXT:    v_lshlrev_b32_e32 v4, 16, v16
; CI-NEXT:    v_lshlrev_b32_e32 v5, 16, v18
; CI-NEXT:    v_lshlrev_b32_e32 v15, 16, v15
; CI-NEXT:    v_lshlrev_b32_e32 v13, 16, v13
; CI-NEXT:    v_mov_b32_e32 v8, s0
; CI-NEXT:    v_or_b32_e32 v7, v17, v4
; CI-NEXT:    v_or_b32_e32 v6, v19, v5
; CI-NEXT:    v_or_b32_e32 v5, v14, v15
; CI-NEXT:    v_or_b32_e32 v4, v12, v13
...
; VI-NEXT:    v_cvt_f16_f32_e32 v4, v4
; VI-NEXT:    s_waitcnt vmcnt(1)
; VI-NEXT:    v_cvt_f16_f32_sdwa v17, v11 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-NEXT:    v_cvt_f16_f32_e32 v18, v10
; VI-NEXT:    v_cvt_f16_f32_sdwa v19, v9 dst_sel:WORD_1 dst_unused:UNUSED_PAD src0_sel:DWORD
; VI-NEXT:    v_cvt_f16_f32_e32 v20, v8
; VI-NEXT:    s_waitcnt vmcnt(0)
...
; VI-NEXT:    v_or_b32_e32 v2, v4, v5
; VI-NEXT:    v_mov_b32_e32 v8, s0
; VI-NEXT:    v_or_b32_e32 v7, v18, v17
; VI-NEXT:    v_or_b32_e32 v6, v20, v19
