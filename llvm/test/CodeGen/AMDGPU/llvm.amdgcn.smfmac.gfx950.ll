...
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_f32_32x32x32_f16 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
...
; GISEL-NEXT:    v_mov_b32_e32 v12, v2
; GISEL-NEXT:    v_mov_b32_e32 v13, v3
; GISEL-NEXT:    v_mov_b32_e32 v14, v4
; GISEL-NEXT:    v_mov_b32_e32 v15, v5
; GISEL-NEXT:    v_mov_b32_e32 v16, v6
; GISEL-NEXT:    v_mov_b32_e32 v17, v7
; GISEL-NEXT:    v_mov_b32_e32 v18, v8
; GISEL-NEXT:    v_mov_b32_e32 v19, v9
; GISEL-NEXT:    v_mov_b64_e32 v[28:29], s[22:23]
; GISEL-NEXT:    v_mov_b32_e32 v20, v10
; GISEL-NEXT:    v_mov_b32_e32 v1, s25
; GISEL-NEXT:    v_mov_b32_e32 v2, s26
; GISEL-NEXT:    v_mov_b32_e32 v3, s27
...
; GISEL-NEXT:    v_mov_b32_e32 v12, v16
; GISEL-NEXT:    v_mov_b32_e32 v13, v17
; GISEL-NEXT:    v_mov_b32_e32 v14, v18
; GISEL-NEXT:    v_mov_b32_e32 v15, v19
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_f32_32x32x32_f16 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x float> @llvm.amdgcn.smfmac.f32.32x32x32.f16(<8 x half> %arg0, <16 x half> %arg1, <16 x float> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x float> %result
}
...
; GCN-NEXT:    s_nop 1
; GCN-NEXT:    v_smfmac_f32_32x32x32_bf16 v[16:31], v[12:15], v[32:39], v10
; GCN-NEXT:    s_nop 7
; GCN-NEXT:    s_nop 3
...
; SDAG-NEXT:    v_mov_b32_e32 v16, s24
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_i32_32x32x64_i8 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b32_e32 v1, v17
; SDAG-NEXT:    v_mov_b32_e32 v2, v18
...
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_i32_32x32x64_i8 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x i32> @llvm.amdgcn.smfmac.i32.32x32x64.i8(<4 x i32> %arg0, <8 x i32> %arg1, <16 x i32> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x i32> %result
}
...
; SDAG-NEXT:    v_mov_b32_e32 v16, s24
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_f32_32x32x64_bf8_bf8 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b32_e32 v1, v17
; SDAG-NEXT:    v_mov_b32_e32 v2, v18
...
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_f32_32x32x64_bf8_bf8 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x float> @llvm.amdgcn.smfmac.f32.32x32x64.bf8.bf8(<4 x i32> %arg0, <8 x i32> %arg1, <16 x float> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x float> %result
}
...
; SDAG-NEXT:    v_mov_b32_e32 v16, s24
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_f32_32x32x64_bf8_fp8 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b32_e32 v1, v17
; SDAG-NEXT:    v_mov_b32_e32 v2, v18
...
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_f32_32x32x64_bf8_fp8 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x float> @llvm.amdgcn.smfmac.f32.32x32x64.bf8.fp8(<4 x i32> %arg0, <8 x i32> %arg1, <16 x float> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x float> %result
}
...
; SDAG-NEXT:    v_mov_b32_e32 v16, s24
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_f32_32x32x64_fp8_bf8 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b32_e32 v1, v17
; SDAG-NEXT:    v_mov_b32_e32 v2, v18
...
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_f32_32x32x64_fp8_bf8 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x float> @llvm.amdgcn.smfmac.f32.32x32x64.fp8.bf8(<4 x i32> %arg0, <8 x i32> %arg1, <16 x float> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x float> %result
}
...
; SDAG-NEXT:    v_mov_b32_e32 v16, s24
; SDAG-NEXT:    s_nop 1
; SDAG-NEXT:    v_smfmac_f32_32x32x64_fp8_fp8 v[16:31], v[12:15], v[32:39], v10
; SDAG-NEXT:    s_nop 7
; SDAG-NEXT:    s_nop 3
; SDAG-NEXT:    v_mov_b32_e32 v1, v17
; SDAG-NEXT:    v_mov_b32_e32 v2, v18
...
; GISEL-NEXT:    v_mov_b32_e32 v0, s24
; GISEL-NEXT:    s_nop 1
; GISEL-NEXT:    v_smfmac_f32_32x32x64_fp8_fp8 v[0:15], v[30:33], v[22:29], v20
; GISEL-NEXT:    s_setpc_b64 s[30:31]
  %result = call <16 x float> @llvm.amdgcn.smfmac.f32.32x32x64.fp8.fp8(<4 x i32> %arg0, <8 x i32> %arg1, <16 x float> %arg2, i32 %arg3, i32 immarg 0, i32 immarg 0)
  ret <16 x float> %result
}
