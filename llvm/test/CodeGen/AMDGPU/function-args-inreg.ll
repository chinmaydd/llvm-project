...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v1, s17 :: v_dual_mov_b32 v2, s18
; GFX11-NEXT:    v_dual_mov_b32 v3, s19 :: v_dual_mov_b32 v0, s16
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v1, s25 :: v_dual_mov_b32 v2, s26
; GFX11-NEXT:    v_dual_mov_b32 v3, s27 :: v_dual_mov_b32 v0, s24
; GFX11-NEXT:    v_dual_mov_b32 v5, s21 :: v_dual_mov_b32 v6, s22
; GFX11-NEXT:    v_dual_mov_b32 v7, s23 :: v_dual_mov_b32 v4, s20
; GFX11-NEXT:    v_dual_mov_b32 v9, s17 :: v_dual_mov_b32 v10, s18
; GFX11-NEXT:    v_dual_mov_b32 v11, s19 :: v_dual_mov_b32 v8, s16
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v5, s17 :: v_dual_mov_b32 v4, s16
; GFX11-NEXT:    v_dual_mov_b32 v1, s1 :: v_dual_mov_b32 v2, s2
; GFX11-NEXT:    v_dual_mov_b32 v3, s3 :: v_dual_mov_b32 v0, s0
; GFX11-NEXT:    s_clause 0x1
...
; GFX11-TRUE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v7, s25 :: v_dual_mov_b32 v8, s26
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v9, s27 :: v_dual_mov_b32 v6, s24
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v11, s21 :: v_dual_mov_b32 v12, s22
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v13, s23 :: v_dual_mov_b32 v10, s20
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v23, s17 :: v_dual_mov_b32 v24, s18
; GFX11-TRUE16-NEXT:    v_dual_mov_b32 v25, s19 :: v_dual_mov_b32 v22, s16
...
; GFX11-FAKE16-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v1, s25 :: v_dual_mov_b32 v2, s26
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v3, s27 :: v_dual_mov_b32 v0, s24
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v5, s21 :: v_dual_mov_b32 v6, s22
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v7, s23 :: v_dual_mov_b32 v4, s20
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v9, s17 :: v_dual_mov_b32 v10, s18
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v11, s19 :: v_dual_mov_b32 v8, s16
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v19, s1 :: v_dual_mov_b32 v20, s2
; GFX11-FAKE16-NEXT:    v_dual_mov_b32 v21, s3 :: v_dual_mov_b32 v18, s0
...
; GFX11-NEXT:    v_dual_mov_b32 v9, s17 :: v_dual_mov_b32 v10, s18
; GFX11-NEXT:    v_dual_mov_b32 v11, s19 :: v_dual_mov_b32 v8, s16
; GFX11-NEXT:    v_dual_mov_b32 v23, s1 :: v_dual_mov_b32 v24, s2
; GFX11-NEXT:    v_dual_mov_b32 v25, s3 :: v_dual_mov_b32 v22, s0
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v3, s16 :: v_dual_mov_b32 v4, s0
; GFX11-NEXT:    v_dual_mov_b32 v5, s1 :: v_dual_mov_b32 v6, s2
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v6, s16 :: v_dual_mov_b32 v3, s1
; GFX11-NEXT:    v_dual_mov_b32 v4, s2 :: v_dual_mov_b32 v5, s3
...
; GFX11-NEXT:    s_add_i32 s32, s32, 16
; GFX11-NEXT:    v_dual_mov_b32 v14, s24 :: v_dual_mov_b32 v3, s21
; GFX11-NEXT:    v_dual_mov_b32 v2, s20 :: v_dual_mov_b32 v7, s17
...
; GFX11-NEXT:    v_dual_mov_b32 v6, s16 :: v_dual_mov_b32 v11, s1
...
; GFX11:       ; %bb.0:
; GFX11-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; GFX11-NEXT:    v_dual_mov_b32 v4, s26 :: v_dual_mov_b32 v3, s25
; GFX11-NEXT:    v_dual_mov_b32 v2, s24 :: v_dual_mov_b32 v5, s27
; GFX11-NEXT:    v_dual_mov_b32 v8, s22 :: v_dual_mov_b32 v7, s21
; GFX11-NEXT:    v_dual_mov_b32 v6, s20 :: v_dual_mov_b32 v9, s23
; GFX11-NEXT:    v_dual_mov_b32 v12, s18 :: v_dual_mov_b32 v11, s17
; GFX11-NEXT:    v_dual_mov_b32 v10, s16 :: v_dual_mov_b32 v13, s19
