...
; GFX9-NEXT:    s_and_b32 s4, s2, 0xffffff
; GFX9-NEXT:    s_and_b32 s5, s3, 0xffffff
...
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_load_dword s3, s[4:5], 0xd
; SI-NEXT:    s_and_b32 s4, s2, 0xffffff
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_and_b32 s5, s3, 0xffffff
; SI-NEXT:    s_mul_i32 s4, s4, s5
; SI-NEXT:    v_mov_b32_e32 v1, s3
; SI-NEXT:    v_mov_b32_e32 v0, s4
; SI-NEXT:    v_mul_hi_u32_u24_e32 v1, s2, v1
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_mov_b32 s2, -1
...
; SI-NEXT:    s_mov_b32 s3, 0xf000
; SI-NEXT:    s_waitcnt lgkmcnt(0)
; SI-NEXT:    s_and_b32 s2, s6, 0xffffff
; SI-NEXT:    s_mul_i32 s4, s2, s2
; SI-NEXT:    s_mov_b32 s2, -1
; SI-NEXT:    v_mov_b32_e32 v0, s4
