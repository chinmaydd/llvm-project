...
; GCN-NEXT:    s_mov_b32 s7, 0xf000
; GCN-NEXT:    buffer_store_short v1, off, s[4:7], 0
...
; GFX89-NEXT:    buffer_store_short v1, off, s[0:3], 0
; GFX89-NEXT:    buffer_store_short v0, off, s[0:3], 0 offset:2
; GFX89-NEXT:    s_endpgm
...
; GFX89-NEXT:    buffer_store_short v0, off, s[0:3], 0 offset:20
; GFX89-NEXT:    s_waitcnt vmcnt(0)
; GFX89-NEXT:    s_endpgm
...
; GCN-NEXT:    s_mov_b64 s[2:3], s[6:7]
; GCN-NEXT:    v_lshlrev_b32_e32 v5, 1, v0
...
; GCN-NEXT:    buffer_store_short v0, v[5:6], s[0:3], 0 addr64
; GCN-NEXT:    s_endpgm
  %tid = call i32 @llvm.amdgcn.workitem.id.x() #1
  %tid.ext = sext i32 %tid to i64
  %in.gep = getelementptr inbounds <8 x i16>, ptr addrspace(1) %in, i64 %tid.ext
