...
; GFX10-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-NEXT:    s_add_i32 s2, s5, s7
; GFX10-NEXT:    s_add_i32 s3, s4, s6
; GFX10-NEXT:    v_mov_b32_e32 v1, s2
...
; GFX10-NEXT:    s_add_i32 s8, s13, s21
; GFX10-NEXT:    s_add_i32 s9, s12, s20
...
; GFX11-NEXT:    s_add_i32 s8, s13, s21
; GFX11-NEXT:    s_add_i32 s9, s12, s20
; GFX11-NEXT:    s_add_i32 s2, s11, s19
; GFX11-NEXT:    s_add_i32 s3, s10, s18
; GFX11-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s8
; GFX11-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v3, s6
; GFX11-NEXT:    v_dual_mov_b32 v0, s9 :: v_dual_mov_b32 v5, s4
...
; GFX12-NEXT:    s_add_co_i32 s8, s13, s21
; GFX12-NEXT:    s_add_co_i32 s9, s12, s20
; GFX12-NEXT:    s_add_co_i32 s2, s11, s19
; GFX12-NEXT:    s_add_co_i32 s3, s10, s18
; GFX12-NEXT:    v_dual_mov_b32 v8, 0 :: v_dual_mov_b32 v1, s8
; GFX12-NEXT:    v_dual_mov_b32 v2, s7 :: v_dual_mov_b32 v3, s6
; GFX12-NEXT:    v_dual_mov_b32 v0, s9 :: v_dual_mov_b32 v5, s4
...
; GFX10-NEXT:    s_add_i32 s16, s21, s49
; GFX10-NEXT:    s_add_i32 s17, s20, s48
...
; GFX11-NEXT:    s_add_i32 s16, s21, s49
; GFX11-NEXT:    s_add_i32 s17, s20, s48
...
; GFX11-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s16
; GFX11-NEXT:    v_dual_mov_b32 v2, s15 :: v_dual_mov_b32 v3, s14
; GFX11-NEXT:    v_dual_mov_b32 v0, s17 :: v_dual_mov_b32 v5, s12
; GFX11-NEXT:    v_dual_mov_b32 v6, s11 :: v_dual_mov_b32 v7, s10
; GFX11-NEXT:    v_dual_mov_b32 v4, s13 :: v_dual_mov_b32 v9, s8
; GFX11-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v11, s6
; GFX11-NEXT:    v_dual_mov_b32 v8, s9 :: v_dual_mov_b32 v13, s4
...
; GFX12-NEXT:    s_add_co_i32 s16, s21, s49
; GFX12-NEXT:    s_add_co_i32 s17, s20, s48
...
; GFX12-NEXT:    v_dual_mov_b32 v16, 0 :: v_dual_mov_b32 v1, s16
; GFX12-NEXT:    v_dual_mov_b32 v2, s15 :: v_dual_mov_b32 v3, s14
; GFX12-NEXT:    v_dual_mov_b32 v0, s17 :: v_dual_mov_b32 v5, s12
; GFX12-NEXT:    v_dual_mov_b32 v6, s11 :: v_dual_mov_b32 v7, s10
; GFX12-NEXT:    v_dual_mov_b32 v4, s13 :: v_dual_mov_b32 v9, s8
; GFX12-NEXT:    v_dual_mov_b32 v10, s7 :: v_dual_mov_b32 v11, s6
; GFX12-NEXT:    v_dual_mov_b32 v8, s9 :: v_dual_mov_b32 v13, s4
; GFX12-NEXT:    v_dual_mov_b32 v14, s3 :: v_dual_mov_b32 v15, s2
; GFX12-NEXT:    v_mov_b32_e32 v12, s5
