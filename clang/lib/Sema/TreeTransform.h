...
#include "llvm/Frontend/OpenMP/OMP.inc"
  ...
  ExprResult RebuildConvertFromArbitraryFPExpr(
      SourceLocation BuiltinLoc, Expr *SrcExpr,
      ConvertFromArbitraryFPExpr::ArbitraryFPFormat Format,
      TypeSourceInfo *DstTInfo, SourceLocation RParenLoc) {
...
ExprResult TreeTransform<Derived>::TransformConvertFromArbitraryFPExpr(
  ...
  return getDerived().RebuildConvertFromArbitraryFPExpr(
      E->getBuiltinLoc(), SrcExpr.get(), E->getFormat(), Type,
      E->getRParenLoc());
}
